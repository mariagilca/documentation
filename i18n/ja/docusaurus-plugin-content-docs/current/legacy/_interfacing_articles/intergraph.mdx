...
![Diagram of how OpenLM interfaces with the Intergraph Smart Licensing Cloud](https://www.openlm.com/wp-content/uploads/2020/09/how-openlm-interfaces-with-the-intergraph-smart-li.png)  
...
:::note
OpenLM Broker must already be [installed](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/) and [configured](https://www.openlm.com/knowledge-base/openlm-broker-configuration/) to report to OpenLM Server before proceeding.
:::
...
3. Expand the left menu → click **API Clients**.  
   ![Selecting API Clients](https://www.openlm.com/wp-content/uploads/2020/09/selecting-api-clients-for-intergraph-smart-licensi.png)
...
![Broker settings for Intergraph Smart Licensing Cloud](https://www.openlm.com/wp-content/uploads/2020/09/openlm-broker-settings-for-intergraph-smart-licens.png)
