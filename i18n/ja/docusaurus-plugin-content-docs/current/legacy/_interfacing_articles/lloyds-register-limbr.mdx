...
![Diagram of how OpenLM interfaces with LiMBR](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42114-1.png)  
...
![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42114-2.png)
...
![Automatic Broker configuration](https://www.openlm.com/wp-content/uploads/2021/02/automatic-broker-configuration.png)

## OpenLM Server configuration

### Automatic configuration via EasyAdmin

1. Open **EasyAdmin** (`http://<OpenLM Server FQDN>:5015` or via **Windows Start → OpenLM → OpenLM EasyAdmin User Interface**).
2. In **License Manager Servers**, approve the new LiMBR entry.

![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42114-4.png)  
![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42114-5.png)

### Manual configuration

1. In EasyAdmin, go to **Administration → License Manager Servers → Add LM**.
2. Set **Type** to **LiMBR**.
3. Enter a display name and description (e.g., LiMBR).
4. Set the time zone.
...
![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42114-6.png)
...
![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42114-7.png)
