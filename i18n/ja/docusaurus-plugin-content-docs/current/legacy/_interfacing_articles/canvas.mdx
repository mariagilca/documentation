...
![Diagram of how OpenLM interfaces with the Canvas License Manager](https://www.openlm.com/wp-content/uploads/2025/05/how-openlm-interfaces-with-the-coscom-licensemonit-1.png)  
...
5. Enter the Canvas port number (for example, `5093`) and click **Add**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-2.png)  
...
6. Select the **Vendors** tab. Click **Add Vendor**.  
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-3.png)  
...
7. Switch to the **Log Files** tab. Click **Add Log File**.  
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-4.png)  
...
2. Click the icon for **Servers Pending Approval**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-5.png)  
   *Pending license managers in EasyAdmin*

3. Double-click the pending license manager.  
   It will be displayed as **OpenLM Generic**.

   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-6.png)  
...
4. (Optional) Modify the display name. Verify the configuration, then click **Approve**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-7.png)  
...
5. (Optional) Switch to the **Custom Fields** tab to add details such as country, usage scope, and description.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-8.png)  
...
3. Verify that the configured license manager appears in the server list.  
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-98722-9.png)  
