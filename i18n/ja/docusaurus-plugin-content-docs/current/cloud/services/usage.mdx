...
Use the **Usage** section to monitor how your organization consumes software licenses in real time and historically. This section helps you:
...
To collect complete data, install and configure the **OpenLM Workstation Agent** on end-user machines. This enables OpenLM to:
