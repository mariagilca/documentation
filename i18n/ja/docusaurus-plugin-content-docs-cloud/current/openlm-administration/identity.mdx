...
description: "Identity では、OpenLM Platform のユーザー管理、外部プロバイダーとのシングルサインオン（SSO）設定、OpenLM コンポーネント用の認可ファイル生成を行えます。"
sidebar_position: 1
---
...
:::info[アプリでの場所]
OpenLM Platform の**アプリランチャー**（右上のグリッドアイコン）を開き、**Platform Administration（プラットフォーム管理）→ Identity** を選択します。
