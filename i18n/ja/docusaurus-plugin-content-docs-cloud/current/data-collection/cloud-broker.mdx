...
title: "Cloud Broker"
sidebar_position: 2
description: "Cloud Broker は SaaS プラットフォームに接続し、ライセンスデータの監視と管理を行う OpenLM プラットフォームサービスです。"
---
...
**関連:** [SaaS プラットフォームドキュメント](/cloud/data-collection/connect-license-managers/saas-platforms/intro)
:::
...
プラットフォーム別の構成ガイドは [SaaS プラットフォームドキュメント](/cloud/data-collection/connect-license-managers/saas-platforms/intro) を参照してください。
