---
title: "ドングル監視(Dongle Monitoring)"
description: "Dongle Monitoring レポートは、ライセンス管理に使用するハードウェアドングルをリアルタイムおよび過去にわたって追跡します。"
sidebar_position: 2
---
...
![ドングル監視（Dongle Monitoring）](/img/reporting/dongle-monitoring.png)
