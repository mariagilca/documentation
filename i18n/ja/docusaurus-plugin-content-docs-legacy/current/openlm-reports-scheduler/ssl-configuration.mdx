...
5. OpenLM SLM フォルダーを開き、params.js ファイルをテキストエディタで開きます（通常の場所: "C:\Program Files\OpenLM\OpenLM Server\bin\wwwroot\params.js"）。
...
8. Windows Services を開き、「OpenLM SLM」サービスを再起動します。
