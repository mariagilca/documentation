...
2019年7月現在、次の[Autodesk Cloud製品](https://www.autodesk.com/360-cloud)が利用可能です：-

- コラボレーション製品 - AutoCADモバイルアプリおよびRecap（リアリティキャプチャ）Pro
- ビルディングおよび建設 - BIM 360、Formit（スケッチャー）、およびプラグイン[Insight](https://www.autodesk.com/products/insight/overview)（ビルディングパフォーマンス分析）
- 製品設計および製造 - [Fusion 360](https://www.autodesk.com/products/fusion-360/overview#banner)、Fusion TeamおよびFusion Lifecycle、ならびにConfigurator 360
- [Autodesk Rendering](https://www.autodesk.com/products/rendering/overview)は、AECや製造のお客様など、組織でレンダリングを使用するAutoCAD、Revit、およびその他の製品ユーザーが利用できます。

ただし、このリストは非常に急速に変化します。リストへの新しい追加は、関連するソフトウェアMayaや3ds Maxの既存のAutodeskサブスクリプションを持つメディアおよびエンターテインメントのお客様向けの[Character Generator](https://www.autodesk.com/products/character-generator/overview)です。

クラウドで作業するために、Autodeskはクラウドプラットフォーム[Autodesk 360](https://www.autodesk.com/products/a360/overview)またはA360も提供しています。
...
Autodesk Cloudは、OpenLMが管理できる70以上のライセンスマネージャーの1つにすぎません。[リストを確認](https://www.openlm.com/license-manager-capabilities/)。
