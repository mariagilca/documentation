...
![スクリーンショット: Security concerns](/img/legacy/word-image-53_1.png)

Broker Browser では Web UI を無効化できます:

![スクリーンショット 2: Security concerns](/img/legacy/word-image-54_1.png)

これにより、Broker XML のポート設定は無効になります:

![スクリーンショット 3: Security concerns](/img/legacy/word-image-55_1.png)
...
![スクリーンショット: Remote login process](/img/legacy/word-image-56_1.png)
...
![スクリーンショット 2: Remote login process](/img/legacy/word-image-57_1.png)
...
1. **OpenLM SLMs** タブで **Add Server** をクリックします。  
   ![スクリーンショット: the OpenLM SLM の追加](/img/legacy/word-image-58_1.png)
2. 接続タイプ（On-premise または OpenLM Cloud）を選択して **Add** をクリックします。  
   ![スクリーンショット 2: the OpenLM SLM の追加](/img/legacy/word-image-59_1.png)
3. OpenLM SLM のホスト名を入力します。Identity Service を使用している場合は Start → Administration → System Security → Security → Authorization → Add で認可ファイルを作成し、Broker Authorization File をインポートして **Save** をクリックします。  
   ![スクリーンショット 3: the OpenLM SLM の追加](/img/legacy/word-image-60_1.png)
...
6. ドロップダウンからライセンスマネージャーの種類を選択し、ポートを入力して **Add** をクリックします。  
   ![スクリーンショット 4: the OpenLM SLM の追加](/img/legacy/word-image-62_1.png)
7. License file 情報を追加します:  
   ![スクリーンショット 5: the OpenLM SLM の追加](/img/legacy/word-image-63_1.png)
8. Commands 情報を追加します。実行ファイルのパスを入力すると、Status と Data_Inquiry のコマンドパスが更新されます。  
   ![スクリーンショット 6: the OpenLM SLM の追加](/img/legacy/word-image-64_1.png)
9. Vendor 情報を入力します:  
   ![スクリーンショット 7: the OpenLM SLM の追加](/img/legacy/word-image-65_1.png)
10. ベンダー名と Options File 情報を追加し、**Confirm** をクリックします。  
    ![スクリーンショット 8: the OpenLM SLM の追加](/img/legacy/word-image-66_1.png)
11. Log File を追加します:  
    ![スクリーンショット 9: the OpenLM SLM の追加](/img/legacy/word-image-67_1.png)
12. Log File Type を選択し、Log name を更新し、ログパスを入力してベンダーを選択します。**Confirm** をクリックしてから **Save** をクリックします。  
    ![スクリーンショット 10: the OpenLM SLM の追加](/img/legacy/word-image-68.png)

## 並列 Broker インスタンスの切り替え

同じマシンに複数の Broker をインストールしている場合、UI から切り替えられます。

![スクリーンショット: Switch between parallel Broker instances](/img/legacy/word-image-69.png)
