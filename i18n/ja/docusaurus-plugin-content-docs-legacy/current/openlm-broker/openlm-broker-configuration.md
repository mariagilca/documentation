...
設定を開くには、**[Start] > [OpenLM] > [OpenLM Broker]** を選択します（既定パス: C:\ProgramData\Microsoft\Windows\Start Menu\Programs\OpenLM\OpenLM Broker）。OpenLM Broker Configuration Tool が起動し（**図 1**）、OpenLM Broker、OpenLM SLM、ライセンスサーバーの設定が行えます。

**![インストール直後の OpenLM Broker Configuration Tool。](/img/legacy/word-image-220.png)  
...
**![Connectivity パネルを表示した OpenLM Broker Configuration Tool。](/img/legacy/word-image-221.png)  
...
**![Clean Buffer の確認画面。](/img/legacy/word-image-222.png)  
...
**![Clean Buffer のリマインダー画面。](/img/legacy/word-image-223.png)  
図 4: Clean Buffer リマインダー**

**![データ変更を保存する確認画面。](/img/legacy/word-image-224.png)  
図 5: 変更内容の確認画面**

ii. Broker が停止している場合、エラー画面が表示されます（**図 6**）。

**![Broker 接続エラー画面。](/img/legacy/word-image-225.png)  
図 6: Broker 接続エラー画面**
...
**![Broker 再起動の成功画面。](/img/legacy/word-image-226.png)  
図 7: Broker 再起動成功画面**
...
**![接続確認のカウントダウン画面。](/img/legacy/word-image-227.png)  
図 8: カウントダウン画面**  
![OpenLM SLM への接続成功画面。](/img/legacy/word-image-228.png)  
**図 9: 接続成功**

**![OpenLM SLM への接続失敗画面。](/img/legacy/word-image-229.png)  
図 10: 接続失敗**
...
![選択したライセンスサーバーの License Manager パネル。](/img/legacy/word-image-230.png)  
...
![Add New Port ダイアログ。](/img/legacy/word-image-231.png)  
...
**![License Manager Port パネルを表示した OpenLM Broker Configuration Tool。](/img/legacy/word-image-232.png)  
...
![Update Commands の確認画面。](/img/legacy/word-image-233.png)

**図 14: Update Commands の確認画面**

7. 確認画面で **[Yes]** をクリックするとデータが確定します。保存完了画面が表示されます（**図 15**）。

**![License Manager の変更を保存した成功画面。](/img/legacy/word-image-234.png)  
...
**![設定ツリーで展開された Commands ノード。](/img/legacy/word-image-235.png)  
...
**![Advanced オプションを表示した License Manager Port パネル。](/img/legacy/word-image-236.png)  
...
**![Add ボタンでライセンスファイルが入力された Path フィールド。](/img/legacy/word-image-237.png)  
...
**![Update Commands の確認画面。](/img/legacy/word-image-238.png)  
...
![ライセンスファイルを並べ替える Asset Info Order 画面。](/img/legacy/word-image-241.png)

**図 22: Asset Info Order 画面**
...
*注: インストール時に一部のパスは自動検出されます。その他のライセンスマネージャーのコマンドパスは既定で C:\Program Files\OpenLM\OpenLM Broker\tools に設定されています。すべてのコマンドがすべてのライセンスマネージャーで利用できるわけではありません。*

1. 設定対象のポートノード左の **[+]** をクリックして展開します（**図 23**）。追加の設定ノードが表示されます。

**![ポートノードを展開した OpenLM Broker Configuration Tool。](/img/legacy/word-image-242.png)  
...
**![コマンドの成功を示す Execute 確認画面。](/img/legacy/word-image-243.png)  
図 24: Execute 成功画面（汎用）**

**![コマンドエラーの内容を示す Execute 確認画面。](/img/legacy/word-image-244.png)  
図 25: Execute エラー画面**
...
**![Apply を選択した後の Command 更新確認画面。](/img/legacy/word-image-245.png)  
...
**![Broker 再起動の確認画面。](/img/legacy/word-image-246.png)  
図 27: Broker 再起動確認画面**
...
**![Command 更新確認画面。](/img/legacy/word-image-247.png)  
図 28: コマンド更新確認画面**

iv. **[Apply]** をクリックして変更を保存します。確認画面が表示されます（**図 29**）。

**![Apply を選択した後の Command 更新確認画面。](/img/legacy/word-image-248.png)  
...
**![Broker 再起動の確認画面。](/img/legacy/word-image-249.png)  
図 30: Broker 再起動確認画面**
...
**![Vendor Name to Be Filled ノードを選択し Vendor Definition フィールドを表示した画面。](/img/legacy/word-image-250.png)  
...
**![Apply を選択した後の Command 更新確認画面。](/img/legacy/word-image-251.png)  
図 32: [Apply] 後のコマンド更新確認画面**

12. **[Restart Broker]** をクリックして新しい設定を適用します。再起動成功画面が表示されます（**図 33**）。

**![Broker 再起動の確認画面。](/img/legacy/word-image-252.png)  
図 33: Broker 再起動確認画面**
...
**![Add Log File ボタンとともにハイライトされた Log Files ノード。](/img/legacy/word-image-253.png)  
...
**![Apply を選択した後の Command 更新確認画面。](/img/legacy/word-image-254.png)  
図 35: [Apply] 後のコマンド更新確認画面**

12. **[Restart Broker]** をクリックして新しい設定を適用します。再起動成功画面が表示されます（**図 36**）。

**![Broker 再起動の確認画面。](/img/legacy/word-image-255.png)  
図 36: Broker 再起動確認画面**
...
**![Advanced Settings パネルを表示した OpenLM Broker Configuration Tool。](/img/legacy/word-image-256.png)  
...
**![Apply を選択した後の Command 更新確認画面。](/img/legacy/word-image-257.png)  
図 38: [Apply] 後のコマンド更新確認画面**

4. **[Restart Broker]** をクリックして新しい設定を適用します。再起動成功画面が表示されます（**図 39**）。

**![Broker 再起動の確認画面。](/img/legacy/word-image-258.png)  
図 39: Broker 再起動確認画面**
...
![Reset 確認画面。](/img/legacy/word-image-259.png)

**図 40: Reset 確認画面**

3. **[Yes]** をクリックして現在の設定の削除を確定します。削除後、既存ライセンスサーバーの検出画面が表示されます（**図 41**）。

**![リセット後に既存のライセンスサーバーを検出している画面。](/img/legacy/word-image-260.png)  
図 41: 既存ライセンスサーバーの検出**

4. **[Restart Broker]** をクリックして新しい設定を適用します。再起動成功画面が表示されます（**図 42**）。

**![Broker 再起動の確認画面。](/img/legacy/word-image-261.png)  
図 42: Broker 再起動確認画面**
...
**![ポート 27080 を選択した Recording Configuration パネル。](/img/legacy/word-image-262.png)  
...
**![Apply、Restart Broker、Exit ボタンがある一般的な OpenLM Broker Configuration Tool 画面。](/img/legacy/word-image-263.png)  
