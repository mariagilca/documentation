...
![Diagram of how OpenLM interfaces with the Datamine license manager](https://www.openlm.com/wp-content/uploads/2022/05/how-openlm-interfaces-with-the-coscom-licensemonit-1.png)  
...
2. Go to **License Managers → Add License Manager**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/05/word-image-74.png)  
3. Select **Datamine**, enter any port number (e.g., `888`), and click **Add**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/05/word-image-75.png)  
4. In **Log Files**, click **Add Log File**.  
5. Enter or browse to the `.csv` log file location.  
   ![](https://www.openlm.com/wp-content/uploads/2022/05/word-image-76.png)  
...
2. Double-click the Datamine entry.  
   ![](https://www.openlm.com/wp-content/uploads/2022/05/word-image-78.png)  
3. Optionally rename the connection, leave the type as **OpenLM Generic**, and click **Approve**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/05/word-image-79.png)
...
4. Enter a description (e.g., "Datamine").  
