...
![Diagram of how OpenLM interfaces with Houdini](https://www.openlm.com/wp-content/uploads/2025/05/word-image-97872-1.png)  
...
2. Go to **License Managers** and click **Detect**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-97872-2.png)  
...
1. Go to **License Managers** → **Add License Manager**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-97872-3.png)  
...
4. In the **Executable Path** field, browse to the root folder where Houdini (`sesinetd`) is installed, then click **Save**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-97872-4.png)  
...
5. Go to the **Vendors** tab. Enter `Houdini` as the vendor name and click **Continue**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-97872-5.png)  
...
4. Locate the Houdini entry and click **Approve**.
   ...
   ![](https://www.openlm.com/wp-content/uploads/2025/05/word-image-97872-6.png)  
