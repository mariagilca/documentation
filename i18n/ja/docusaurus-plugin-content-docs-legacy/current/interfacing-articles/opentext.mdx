---
title: OpenText
description: "OpenLM は OpenText と連携してライセンス使用状況や統計情報を取得でき、本ガイドは OpenLM Broker v4.8.8 以降との連携に基づいています。"
sidebar_position: 59
---
...
![図: OpenLM が OpenText と連携する仕組み。](/img/legacy/how-openlm-interfaces-with-opentext.png)  
...
![OpenText 向けの OpenLM Broker ログファイル設定。](/img/legacy/openlm-broker-log-config-for-opentext.png)  
![OpenText の Broker プロパティ値の説明。](/img/legacy/opentext-properties-values-explained.png)
...
![EasyAdmin で OpenText ライセンスサーバーを手動で追加。](/img/legacy/Screenshot-2024-04-11-at-10.58.18.png)  
![EasyAdmin で OpenText ライセンスサーバーの手動設定を完了。](/img/legacy/Screenshot-2024-04-11-at-11.01.18.png)
