...
1. 組織内のマシンに OpenLM SLM v5.0 以降をインストール済み。
...
:::note
OpenLM Broker は事前に[インストール](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/)し、OpenLM SLM にレポートするよう[設定](../openlm-broker/openlm-broker-configuration.md)しておく必要があります。
:::
...
これで設定が有効になり、EasyAdmin と OpenLM SLM 設定ツールの両方に表示されます。
