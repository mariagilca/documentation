...
続行する前に、Broker を [インストール](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/) し、OpenLM Server へレポートするよう [設定](../openlm-broker/openlm-broker-configuration.md) しておく必要があります。
