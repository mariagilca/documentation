...
![Broker のプロパティファイルで GitLab のログイン情報を編集。](/img/legacy/word-image-2-1.png)  
6. Broker で **Execute** をクリックし、続いて **Apply** をクリックします。ライセンスデータの出力が表示されることを確認します。  
![OpenLM Broker デスクトップ UI で GitLab のライセンスデータ出力を確認。](/img/legacy/word-image-3-1.png)  
...
![EasyAdmin の Pending Approval 一覧から GitLab ライセンスマネージャーを承認。](/img/legacy/word-image-4-1.png)  
