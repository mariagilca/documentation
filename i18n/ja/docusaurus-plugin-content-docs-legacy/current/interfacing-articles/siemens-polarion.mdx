...
2. **License Managers** → **Add License Manager** に移動します。  
   ![スクリーンショット: OpenLM Broker configuration](/img/legacy/word-image-59527-2.png)  
3. ドロップダウンから **Siemens Polarion** を選択し、ログファイルのみを使用するため任意のポート番号（例: 888）を入力して **Add** をクリックします。  
   ![スクリーンショット 2: OpenLM Broker configuration](/img/legacy/word-image-59527-3.png)  
4. **Vendors** タブで **Add Vendor** をクリックし、`Siemens Polarion` を入力して **Continue** をクリックします。  
   ![スクリーンショット 3: OpenLM Broker configuration](/img/legacy/word-image-59527-4.png)  
5. **Log Files** タブに移動します。  
   ![スクリーンショット 4: OpenLM Broker configuration](/img/legacy/word-image-59527-5.png)  
...
2. **Servers pending approval** のアイコンをクリックします。  
   ![スクリーンショット: Automatic configuration through EasyAdmin](/img/legacy/word-image-59527-6.png)  
3. Siemens Polarion のエントリ（**OpenLM Generic** と表示）を選択します。  
4. 必要に応じて表示名を入力し、タイムゾーンを確認します。  
5. **Approve** をクリックします。  
   ![スクリーンショット 2: Automatic configuration through EasyAdmin](/img/legacy/word-image-59527-7.png)  
...
8. **Save** をクリックします。  
   ![スクリーンショット: Manual configuration (if automatic fails)](/img/legacy/word-image-59527-9.png)  
