---
title: VSLM
description: "次の手順に従って、Kisters VSLM License Manager からのライセンス使用状況の監視と統計の取得を行うように OpenLM を設定します。"
sidebar_position: 85
---
...
3. ドロップダウンから **VSLM** を選択し、ポート番号（例: `888`）を入力して **Add** をクリックします。
   ...
   ![OpenLM Broker の Web UI で VSLM ライセンスマネージャーを追加。](/img/legacy/word-image-90713-2.png)

4. **Commands** で設定を確認し、必要に応じて調整します。

   ![OpenLM Broker の Commands タブで VSLM の設定を確認。](/img/legacy/word-image-90713-3.png)

5. **Vendors** で **Add Vendor** をクリックし、`VSLM` を入力して **Continue** をクリックします。

   ![OpenLM Broker の Vendors タブで VSLM ベンダーを追加。](/img/legacy/word-image-90713-4.png)

6. **Log Files** で **Add Log File** をクリックし、VSLM のログ位置を指定して **Watch file by pattern** がオフになっていることを確認します。

   ![OpenLM Broker の Log Files タブで VSLM のログファイルを追加。](/img/legacy/word-image-90713-5.png)
...
4. 保留中のライセンスマネージャー（**OpenLM Generic** と表示）をダブルクリックし、内容を確認して **Approve** をクリックします。
   ...
   ![EasyAdmin で承認待ちの VSLM ライセンスマネージャーを承認。](/img/legacy/word-image-90713-6.png)
