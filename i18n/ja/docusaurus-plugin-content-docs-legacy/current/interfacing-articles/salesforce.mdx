...
4. Connected App で生成した Salesforce API 資格情報（Consumer Key と Consumer Secret）  
   ...
   ![スクリーンショット: Requirements](/img/legacy/word-image-89556-1.png)
...
:::
   ...
   ![スクリーンショット 2: Requirements](/img/legacy/word-image-89556-2.png)
...
2. **License Managers** → **Add License Manager** に移動します。
   ...
   ![スクリーンショット: Steps](/img/legacy/word-image-89556-3.png)
...
2. **License Manager Servers** で **Servers pending approval** アイコンをクリックします。
   ...
   ![スクリーンショット: OpenLM Server configuration](/img/legacy/word-image-89556-6.png)

3. Salesforce のエントリ（**OpenLM Generic** と表示）を選択し、内容を確認して **Approve** をクリックします。  
   （任意）**Country**、**Usage Scope**、**Description** などのメタデータを追加します。

   ![スクリーンショット 2: OpenLM Server configuration](/img/legacy/word-image-89556-7.png)
