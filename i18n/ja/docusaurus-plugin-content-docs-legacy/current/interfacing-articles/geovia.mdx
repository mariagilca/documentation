...
1. Broker 設定ツールで **Detect** をクリックします。  
   ![スクリーンショット: Automatic configuration](/img/legacy/word-image-42295-2.png)  
...
2. ドロップダウンから **GEOVIA** を選択し、ポート番号を入力します。  
   ![スクリーンショット: Alternative: Broker Web UI configuration](/img/legacy/Screenshot-2023-03-17-at-12.31.24.png)  
3. **Commands** で `NetworkLicenceManager.exe` のパスを設定します。  
4. **Vendors** で **Dassault Systèmes** または任意の名称を追加します。  
   ![スクリーンショット 2: Alternative: Broker Web UI configuration](/img/legacy/Screenshot-2023-03-17-at-12.44.45.png)  
...
2. **License Manager Servers** で *Pending approval* のサーバーを見つけます。  
   ![スクリーンショット: Automatic configuration (EasyAdmin)](/img/legacy/word-image-42295-4.png)  
3. 保留中サーバーを編集し、必要に応じて **Display name** を更新して **Approve** をクリックします。  
   ![スクリーンショット 2: Automatic configuration (EasyAdmin)](/img/legacy/word-image-42295-5.png)  

これで GEOVIA License Manager が OpenLM Server に追加されます。  
![スクリーンショット 3: Automatic configuration (EasyAdmin)](/img/legacy/word-image-42295-7.png)  
...
![スクリーンショット: Manual configuration (EasyAdmin)](/img/legacy/word-image-42295-8.png)  
...
![スクリーンショット: monitoring の確認](/img/legacy/word-image-42295-9.png)  
