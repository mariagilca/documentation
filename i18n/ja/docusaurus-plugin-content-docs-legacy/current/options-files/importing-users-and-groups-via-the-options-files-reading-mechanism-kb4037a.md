...
OpenLMには、[さまざまなエンティティをデータベースに導入する](../openlm-slm-features/openlm-group-usage/introducing-entities-in-openlm-users-groups-ip-and-hosts.md)いくつかの方法があります。このアプリケーションノートでは、FlexLMオプションファイルを読み取るOpenLMの機能を利用するこのような方法について詳しく説明します。
