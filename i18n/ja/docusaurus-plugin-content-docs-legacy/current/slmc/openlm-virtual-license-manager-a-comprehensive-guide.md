...
3. OpenLM Cloud Portal で Virtual License Manager のプロダクトを有効化します。  
   ![スクリーンショット: How to access Virtual ライセンスマネージャー](/img/legacy/word-image-56627-1.png)
...
- Admin Role のユーザーが Virtual License Manager (VLM) を開くと、次の UI が表示されます:  
  ![スクリーンショット 2: How to access Virtual ライセンスマネージャー](/img/legacy/word-image-56627-2.png)

- Manager Role のユーザーが Virtual License Manager (VLM) を開くと、次の UI が表示されます:  
  ![スクリーンショット 3: How to access Virtual ライセンスマネージャー](/img/legacy/word-image-56627-3.png)
...
3. "Available Features" の数量は Virtual License Manager に割り当て可能な feature 数を示します。各 feature は 1 回だけ Virtual License Manager に割り当て可能です。feature を割り当てると、該当 Physical License Manager の "Available Features" 数が減少します。  
   **![スクリーンショット: Admin Role User guide](/img/legacy/word-image-56627-4.png)**
...
- 検索フィールドを使って特定の Physical License Manager を簡単に見つけられます。探している名前を入力すると、表が自動的に絞り込まれます。  
  ![スクリーンショット: Search](/img/legacy/word-image-56627-5.png)
...
- 現在のページやタブの情報が必要な場合は、ヘッダー右側の情報 "i" アイコンをクリックします。該当ページやタブに関する詳細が表示されます。  
  ![スクリーンショット: Information](/img/legacy/word-image-56627-6.png)
...
- 列の管理、印刷、エクスポートは Physical License Managers 表と同様に行えます。  
  ![スクリーンショット: View Physical license manager features](/img/legacy/word-image-56627-7.png)![スクリーンショット 2: View Physical license manager features](/img/legacy/word-image-56627-8.png)
...
1. Virtual License Manager を作成するには、Physical License Managers タブを選択し、"Create Virtual LM" ボタンをクリックします。  
   ![スクリーンショット: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-9.png)
...
3. 片方または両方の Physical License Managers から必要な features を選択して Virtual License Manager に割り当てたら、"SAVE" をクリックします。操作をキャンセルしたり前のページに戻る場合は、"CANCEL" をクリックします。  
   ![スクリーンショット 2: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-10.png)![スクリーンショット 3: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-11.png)
...
- "Total Features" の数量は、利用可能ライセンスの有無に関係なく Virtual License Manager に紐づく feature の総数を表示し、該当 Virtual License Manager の全 feature を把握できます。  
  ![スクリーンショット 4: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-12.png)
...
- 現在のページ/タブの情報を確認するには、ヘッダー右側の "i" アイコンをクリックします。ページ名が表示されます。  
  ![スクリーンショット 5: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-13.png)
...
- 列の管理、印刷、エクスポートは Virtual License Manager 表と同様に行えます。  
  ![スクリーンショット 6: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-14.png)![スクリーンショット 7: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-15.png)

- Virtual License Manager を削除するには、対象を選択して "Delete" ボタンをクリックします。  
  ![スクリーンショット 8: a Virtual ライセンスマネージャー の作成](/img/legacy/word-image-56627-16.png)

#### Creating a Virtual Pool

1. Virtual Pool を作成するには、表の一覧から 1 つの Virtual License Manager を選択し、"Create Virtual Pool" ボタンをクリックします。  
   ![スクリーンショット: a Virtual Pool の作成](/img/legacy/word-image-56627-17.png)
...
4. 前のページに戻る、または操作をキャンセルする場合は "CANCEL" をクリックします。  
   ![スクリーンショット 2: a Virtual Pool の作成](/img/legacy/word-image-56627-18.png)
...
7. Features 表示を閉じるには、クロスクローズアイコンをクリックします。列の管理、印刷、エクスポートは Virtual Pool 表と同様に行えます。  
   ![スクリーンショット 3: a Virtual Pool の作成](/img/legacy/word-image-56627-19.png)![スクリーンショット 4: a Virtual Pool の作成](/img/legacy/word-image-56627-20.png)

- Virtual Pool を削除するには、対象を選択して "Delete" ボタンをクリックします。  
  ![スクリーンショット 5: a Virtual Pool の作成](/img/legacy/word-image-56627-21.png)

#### Users

1. Manager Role のユーザーを表示するには "Users" タブを選択します。  
   ![スクリーンショット: Users](/img/legacy/word-image-56627-22.png)
2. OpenLM Virtual License Manager の Manager Role ユーザーを作成するには、Cloud Portal にログインし、左側タブメニューから "Identity & Access Management(IAM) → Users" を選択して "Invite User" ボタンをクリックします。  
   ![スクリーンショット 2: Users](/img/legacy/word-image-56627-23.png)
...
7. ユーザーがメール内のリンクをクリックしてパスワードを設定すると、"Manager Role" として Virtual License Manager にログインできます（"Viewer" ロールとして Cloud Portal にもアクセスでき、Cloud Portal の製品一覧から Virtual License Manager を開けます）。  
   ![スクリーンショット 3: Users](/img/legacy/word-image-56627-24.png)

### Manager Role user guide

- Manager Role で利用できるタブは Virtual Pools タブです。利用できる機能と操作は次のとおりです:  
  ![スクリーンショット: Manager Role user guide](/img/legacy/word-image-56627-25.png)
...
- 表ヘッダー右上の 3 つの点が並んだアイコンを使って、列の順序変更、サイズ変更、削除ができます。同じアイコンで表の印刷や CSV エクスポートも可能です。現在のページやタブの情報を表示するには、ヘッダー右側の情報 "i" アイコンをクリックします。  
  ![スクリーンショット: Managing the appearance of the columns](/img/legacy/word-image-56627-26.png)
...
- Virtual Pool のレコード末尾の "View" アイコンをクリックすると Features を表示できます。Feature 名を検索するには検索フィールドを使用します。Features 表示を閉じるにはクロスクローズアイコンをクリックします。列の管理、印刷、エクスポートは Virtual Pool 表と同様に行えます。  
  ![スクリーンショット: Obtaining features information](/img/legacy/word-image-56627-27.png)![スクリーンショット 2: Obtaining features information](/img/legacy/word-image-56627-28.png)

#### Managing license allocation

- Manager は表の一覧から 1 つの Virtual Pool を選択し、"Manage Licenses Allocations" ボタンをクリックしてライセンス割り当てを管理できます。  
  ![スクリーンショット: Managing license allocation](/img/legacy/word-image-56627-29.png)

- "ALLOCATE POOL" ページが表示されます。  
  ![スクリーンショット 2: Managing license allocation](/img/legacy/word-image-56627-30.png)
...
- 割り当ての変更: ライセンスを割り当てると "Available" が減り "Device Ids" が増加します。割り当てを解除すると逆になります。  
  ![スクリーンショット 3: Managing license allocation](/img/legacy/word-image-56627-31.png)

- Device または User にライセンスを割り当てるには、表から feature を選択して "Execute Licenses Allocations" をクリックします。  
  ![スクリーンショット 4: Managing license allocation](/img/legacy/word-image-56627-32.png)
...
- 変更の保存: "SAVE" をクリックして変更を適用します。  
  ![スクリーンショット 5: Managing license allocation](/img/legacy/word-image-56627-33.png)
...
- OpenLM Virtual License Manager と実機/サーバー間には 1〜2 分の同期時間があります。  
  ![スクリーンショット 6: Managing license allocation](/img/legacy/word-image-56627-34.png)

- ライセンス割り当ての解除や Device/User の説明変更を行うには、"Device Ids" 列の数値（リンク）をクリックします。次のページが表示されます:  
  ![スクリーンショット 7: Managing license allocation](/img/legacy/word-image-56627-35.png)
...
- ヘッダー右側の情報 "i" アイコンでページ名を表示できます。  
  **![スクリーンショット 8: Managing license allocation](/img/legacy/word-image-56627-36.png)**

- Device または User の説明を編集するには、該当レコード末尾の "Edit" ボタンをクリックします。説明を変更できるフォームが表示されます:  
  ![スクリーンショット 9: Managing license allocation](/img/legacy/word-image-56627-37.png)![スクリーンショット 10: Managing license allocation](/img/legacy/word-image-56627-38.png)
...
- OpenLM Virtual License Manager と実機/サーバー間には 1〜2 分の同期時間があります。  
  ![スクリーンショット 11: Managing license allocation](/img/legacy/word-image-56627-39.png)![スクリーンショット 12: Managing license allocation](/img/legacy/word-image-56627-40.png)
