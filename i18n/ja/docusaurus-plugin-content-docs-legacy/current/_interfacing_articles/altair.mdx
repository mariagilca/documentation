...
> Make sure OpenLM Broker is already [installed](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/) and [configured](https://www.openlm.com/knowledge-base/openlm-broker-configuration/) to report to OpenLM Server before continuing.

### Automatic Broker configuration

1. In the Broker configuration tool, click **Detect**.  
   ![Autodetect Altair License Server](https://www.openlm.com/wp-content/uploads/2021/02/autodetect-altair-license-server-1.png)  
...
3. Under **Commands**, set the path to the folder containing `almutil.exe` (e.g. `C:\Program Files\Altair\licensing13.3\bin`). Click **Update → Apply**.  
4. Under **Vendors**, select “Vendor Name to Be Filled” and enter a descriptive name (e.g. “Altair”). Click **Apply**.  
5. Click **Restart Broker**.  
6. Continue with OpenLM Server configuration (below).  

![Broker configuration for Altair License Server](https://www.openlm.com/wp-content/uploads/2021/02/openlm-broker-configuration-for-altair-license-ser-1.png)  
...
3. Approve the ALS server.  
   ![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42294-3.png) ![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42294-4.png)  
...
4. Add an optional **Description** (e.g. “Altair License Server”).  
5. Set the **Time Zone** to match the server location.  
6. Enter the **Hostname** and **Port** (default: **6200**).  
7. Enable **Triad configuration** if applicable.  
8. Check **Use Broker**.  
9. Click **Save**.  

![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42294-5.png)  
...
![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42294-6.png)  
