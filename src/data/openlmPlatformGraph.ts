...
export const OPENLM_PLATFORM_NODES: PlatformNode[] = [
  ...
  { id: 'identity', label: 'Identity', group: 'core', href: '/cloud/openlm-administration/identity' },
  { id: 'users-and-groups', label: 'Users and Groups', group: 'core', href: '/cloud/users/users-and-groups' },
  { id: 'products', label: 'Products', group: 'core', href: '/cloud/openlm-administration/products' },
  { id: 'projects', label: 'Projects', group: 'core', href: '/cloud/users/projects' },
  { id: 'personal-dashboard', label: 'Personal Dashboard', group: 'core', href: '/cloud/users/personal-dashboard' },
  { id: 'homepage', label: 'Homepage', group: 'core', href: '/cloud/openlm-administration/homepage' },
  { id: 'ui-configurations', label: 'UI Configurations', group: 'core', href: '/cloud/openlm-administration/ui-configuration' },
  {
    id: 'database-configuration-tool',
    label: 'Database Configuration Tool',
    group: 'core',
    href: '/cloud/openlm-administration/database-configuration-tool',
  },
  { id: 'license-manager', label: 'License Manager', group: 'core', href: '/cloud/openlm-administration/license-manager' },
  { id: 'licenses', label: 'Licenses', group: 'core', href: '/cloud/slm/licenses' },
  { id: 'license-servers', label: 'License Servers', group: 'core', href: '/cloud/slm/license-servers' },
  { id: 'license-allocations', label: 'License Allocations', group: 'core', href: '/cloud/slm/license-allocations' },
  { id: 'lfm', label: 'License File Management', group: 'core', href: '/cloud/lfm' },
  { id: 'vlm', label: 'Virtual License Manager', group: 'core', href: '/cloud/vlm' },

  { id: 'agents-hub', label: 'Agents Hub', group: 'collection', href: '/cloud/data-collection/agents_hub' },
  { id: 'broker-hub', label: 'Broker Hub', group: 'collection', href: '/cloud/data-collection/broker-hub' },
  { id: 'cloud-broker', label: 'Cloud Broker', group: 'collection', href: '/cloud/data-collection/cloud-broker' },
  { id: 'directory-sync', label: 'Directory Sync', group: 'collection', href: '/cloud/users/directory-sync' },
  {
    id: 'agent-activity-manager',
    label: 'Agent Activity Manager',
    group: 'collection',
    href: '/cloud/data-collection/agent_activity_manager',
  },
  { id: 'process-manager', label: 'Process Manager', group: 'collection', href: '/cloud/data-collection/process-manager' },
  { id: 'dongle-monitoring', label: 'Dongle Monitoring', group: 'collection', href: '/cloud/dongle-monitoring' },

  { id: 'alerts', label: 'Alerts', group: 'automation', href: '/cloud/automations/alerts' },
  { id: 'notifications', label: 'Notifications', group: 'automation', href: '/cloud/automations/notifications' },
  { id: 'lac', label: 'License Access Control', group: 'automation', href: '/cloud/automations/lac' },
  {
  ...
  { id: 'compliance', label: 'Compliance', group: 'automation', href: '/cloud/compliance' },
  { id: 'audit', label: 'Audit', group: 'automation', href: '/cloud/openlm-administration/audit' },
  { id: 'sam', label: 'Software Asset Management', group: 'automation', href: '/cloud/sam' },
...

  {
    ...
    group: 'integration',
    href: '/cloud/integrations/freshworks-alerts',
  },
  {
    id: 'salesforce-alerts-integration',
    label: 'Salesforce Alerts Integration',
    group: 'integration',
    href: '/cloud/integrations/salesforce-alerts',
  },
  { id: 'zoho-alerts-integration', label: 'Zoho Alerts Integration', group: 'integration', href: '/cloud/integrations/zoho-alerts' },
