...
- **Method 3:** Install OpenLM Broker on the IBM LUM license server. Broker queries locally and sends data to Server. This is the **recommended method** because it enables denial reporting and other advanced features.  
...
![LM tools configuration with i4blt](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42308-1.png)
...
7. For **Enable HAL configuration**, check this if using [High Availability Licensing (HAL)](https://www.openlm.com/knowledge-base/license-server-redundancy-constellations-flexera-triad-ibm-high-availability-licensing-hal-dsls-cluster/).  
...
![IBM LUM license server configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42308-2.png)

---

## Methods 2 and 3: OpenLM installed on a different machine

- **Method 2:** Server queries IBM LUM remotely via the LUM client.  
...
![Broker configuration for IBM LUM](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42308-3.png)

### Broker configuration for HAL

If HAL is enabled, include all cluster servers:  
...
![Add IBM LUM in Broker web UI](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42308-4.png)
...
![Broker UI configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42308-5.png)
