...
![OpenLM Server interfacing directly with LM-X](https://www.openlm.com/wp-content/uploads/2021/02/openlm-server-interfacing-directly-with-the-lm.png)  
...
![MathLM tool configuration](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42292-2.png)
...
![LMX server configuration](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42292-3.png)

OpenLM Server can now query your LM-X license server and present usage information in EasyAdmin.

## Option 2: OpenLM Broker

![Broker interfacing with LM-X](https://www.openlm.com/wp-content/uploads/2021/02/broker-interface-with-log-and-license-files.png)  
...
![Broker LM-X command configuration](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42292-5.png)
...
2. Under **License Managers**, select LM Type **LMX** and input the port. Click **Add**.  
   ![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42292-6.png)  
3. Add the vendor: switch to the **Vendors** tab → **Add Vendor** → enter a name → **Continue**.  
   ![](https://www.openlm.com/wp-content/uploads/2021/02/word-image-42292-8.png)  
4. Click **Save**.  
