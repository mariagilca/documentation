...
![Diagram: OpenLM interfacing with Moldex3D License Manager](https://cdn.openlm.com/wp-content/uploads/2021/02/openlm-interfacing-with-moldex3d-license-manager-d.png)
...
:::note
Ensure Broker is [installed](https://www.openlm.com/knowledge-base/openlm-broker-installation-21-xand-higher-windows/) and [configured](https://www.openlm.com/knowledge-base/openlm-broker-configuration/) to report to OpenLM Server before proceeding.
:::

### Automatic Broker configuration

1. In Broker, click **Detect**.  
   ![Broker auto-detect for Moldex3D](https://cdn.openlm.com/wp-content/uploads/2021/02/openlm-broker-auto-detect-for-moldex3d-lm.png)  
...
![Manual Broker configuration for Moldex3D](https://cdn.openlm.com/wp-content/uploads/2021/02/openlm-broker-configuration-for-moldex3d-license-m.png)
...
3. Go to **License Managers**.  
   ...
   ![Add Moldex3D LM in Broker Web UI](https://cdn.openlm.com/wp-content/uploads/2021/02/Screenshot-2023-03-17-at-11.57.23-1.png)  
...
5. In **Vendors**, click **Add Vendor**, enter `Moldex3D`, and click **Continue**.  
   ![Vendors tab in Broker UI](https://cdn.openlm.com/wp-content/uploads/2021/02/Screenshot-2023-03-17-at-12.10.24.png)  
6. Click **Save**.  
...
2. In **License Manager Servers**, click **There are # servers pending approval**.  
   ![Pending approval in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42310-4.png)  
3. Edit the pending LM entry (double-click or use the pencil icon).  
   ![Edit pending LM](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42310-5.png)  
4. Update the **Display name** if desired.  
5. Click **Approve**.  
   ![Approve Moldex3D in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42310-6.png)  
6. The Moldex3D License Manager is now added.  
   ![Approved Moldex3D LM in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42310-7.png)
...
![Manual server configuration for Moldex3D](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42310-8.png)
...
![Verify Moldex3D in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42310-9.png)
