...
sidebar_label: "Introducing Entities in OpenLM - Users, Groups, IP and Hosts"
---

<!-- Source: https://www.openlm.com/knowledge-base/introducing-entities-in-openlm-users-groups-ip-and-hosts/ -->
...
![](/img/legacy/kb/word-image-26336-1-1.png)
...
3. Click **Add Group** and Insert the required data, Insert information for the **Group Name**, and click **OK**.  
   ![](/img/legacy/kb/word-image-26336-2-1.png)
...
![](/img/legacy/kb/word-image-26336-3-1.png)
...
![](/img/legacy/kb/word-image-26336-4-1.png)
...
4. Select the newly added group, and click the "Members' icon. The Members of the "test test test" window opens (see image).  
   ![](/img/legacy/kb/word-image-26336-5-1.png)
