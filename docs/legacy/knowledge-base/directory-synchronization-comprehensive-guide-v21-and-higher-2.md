...
sidebar_label: "Directory Sync v2x Configuration"
---

<!-- Source: https://www.openlm.com/knowledge-base/directory-synchronization-comprehensive-guide-v21-and-higher/#post-34440-_7lb0bznwhkg0 -->

# Directory Sync v2x Configuration

This is a comprehensive guide on how to synchronize the OpenLM Database with an organization's directory service using **Directory Sync.** To see how to set up Directory Sync on Cloud, follow [this guide](https://www.openlm.com/docs/setting-up-cloud-directory-sync/).

To see the **Mappings between Ldap attributes and OpenLM User attributes**, click on this [link.](https://www.openlm.com/wp-content/uploads/2022/06/Mappings-between-Ldap-attributes-and-OpenLM-User-attributes.pdf)
...
![](/img/legacy/kb/word-image-34440-1.png)
...
**Note:** *If you use Identity Service, configure the DSS in the Identity Service and restart the DSS service. Use* [*this guide*](https://www.openlm.com/docs/openlm-identity-service-installation-guide/identity-service-configuration/) *for more. If you do not use Identity Service - then no login is required.*

2. On the left menu, click on the **Service Configuration** tab.

3. Fill in the details as follows:

![](/img/legacy/kb/word-image-34440-7.png)
...
![](/img/legacy/kb/word-image-34440-8.png)
...
![](/img/legacy/kb/word-image-34440-9.png)
...
![](/img/legacy/kb/word-image-34440-10.png)

![](/img/legacy/kb/word-image-34440-11.png)
...
6. Set in the DSS UI [DSS SERVER IP/Hostname] field the new URL (https://FQDN).
...
**![](/img/legacy/kb/word-image-34440-15.png)**
...
*![](/img/legacy/kb/word-image-34440-16.png)*
...
**![](/img/legacy/kb/word-image-34440-20.png)**
...
![](/img/legacy/kb/word-image-34440-21.png)
...
![](/img/legacy/kb/word-image-34440-30.png)
...
![](/img/legacy/kb/word-image-34440-33.png)
...
![](/img/legacy/kb/word-image-34440-34.png)
...
![](/img/legacy/kb/word-image-34440-37.png)
...
For more details about AzureAd synchronization consult this [link](https://www.openlm.com/wp-content/uploads/2022/01/DS-Support-Azure-Direcory-.pdf).

For more details about Google CDS consult this [link.](https://www.openlm.com/wp-content/uploads/2022/04/DSS-Support-Google-CDS.pdf)

For more details about Okta integration consult this [link.](https://www.openlm.com/docs/wp-content/uploads/2024/04/Directory-Sync-Okta-support.pdf)
...
![](/img/legacy/kb/word-image-34440-38.png)
...
![](/img/legacy/kb/word-image-34440-39.png)
...
![](/img/legacy/kb/image-1.png)

![](/img/legacy/kb/word-image-34440-41.png)
...
![](/img/legacy/kb/word-image-34440-42.png)
...
*![](/img/legacy/kb/word-image-34440-43.png)*

Link to the mapping details [here](https://www.openlm.com/wp-content/uploads/2022/06/Mappings-between-Ldap-attributes-and-OpenLM-User-attributes.pdf).

6.3.2. Manually trigger a synchronization

Clicking the

![](/img/legacy/kb/word-image-34440-44.png)
...
![](/img/legacy/kb/word-image-34440-45.png)

#### Reset entity-relationship data

Clicking the

![](/img/legacy/kb/word-image-34440-46.png)
...
![](/img/legacy/kb/word-image-34440-47.png)
...
![](/img/legacy/kb/word-image-34440-48.png)

![](/img/legacy/kb/word-image-34440-49.png)
...
![](/img/legacy/kb/word-image-34440-50.png)
...
![](/img/legacy/kb/word-image-34440-51.png)
...
![](/img/legacy/kb/word-image-34440-52.png)

![](/img/legacy/kb/word-image-34440-53.png)
