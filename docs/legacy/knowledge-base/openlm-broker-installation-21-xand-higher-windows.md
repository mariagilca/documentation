...
sidebar_label: "OpenLM Broker Installation on Windows"
---

<!-- Source: https://www.openlm.com/knowledge-base/openlm-broker-installation-21-xand-higher-windows/ -->
...
![OpenLM Broker Installer wizard welcome screen.](/img/legacy/kb/openlm-broker-installer-wizard-welcome-screen-.png)

**Figure 1: Installation preparation screen.**

**![](/img/legacy/kb/word-image-16.png)**
...
![](/img/legacy/kb/word-image-17.png)
...
![](/img/legacy/kb/word-image-18.png)
...
![](/img/legacy/kb/word-image-19.png)
...
![](/img/legacy/kb/word-image-20.png)
...
![](/img/legacy/kb/word-image-21.png)
...
![](/img/legacy/kb/word-image-22.png)

**Figure 8: Installation progress screen.**

![](/img/legacy/kb/Screenshot-2024-07-02-at-19.12.13.png)
...
2. Indicate the URL to the Easy Admin:  
   ![](/img/legacy/kb/Screenshot-2024-07-02-at-19.13.23.png)
...
6. In the next prompt, the Client Secret and Client ID will be displayed. These must be imported into the Broker. There are two options to perform this action: either by downloading the JSON file or using the Copy&Paste command. Select the convenient one then go back to the Broker:  
   ![](/img/legacy/kb/word-image-28.png)
...
8. After importing the Authorization File, the fields will be automatically populated. The same actions can be done with the Copy&Paste commands. Click **[Next].  
   ![](/img/legacy/kb/Screenshot-2024-07-02-at-19.18.39.png)**
...
![](/img/legacy/kb/word-image-30.png)
...
![](/img/legacy/kb/word-image-31.png)
...
![](/img/legacy/kb/word-image-32.png)
...
![](/img/legacy/kb/word-image-33.png)
...
![](/img/legacy/kb/word-image-34.png)
...
![](/img/legacy/kb/word-image-35.png)
...
![](/img/legacy/kb/word-image-36.png)

**Figure 17: Installation progress screen.**

**![](/img/legacy/kb/word-image-37.png)**
...
![](/img/legacy/kb/word-image-38.png)
...
![](/img/legacy/kb/word-image-39-1.png)
...
![](/img/legacy/kb/word-image-40-1.png)
...
![](/img/legacy/kb/word-image-41.png)
...
![](/img/legacy/kb/word-image-42.png)
...
![](/img/legacy/kb/word-image-43.png)
...
![](/img/legacy/kb/word-image-44.png)
...
**![](/img/legacy/kb/word-image-45.png)**
...
![](/img/legacy/kb/word-image-46.png)
