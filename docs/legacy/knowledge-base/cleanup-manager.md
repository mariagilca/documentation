...
sidebar_label: "Cleanup Manager module"
---

<!-- Source: https://www.openlm.com/knowledge-base/cleanup-manager/ -->
...
![](/img/legacy/kb/word-image-88.png)
...
![](/img/legacy/kb/word-image-89.png) If **Yes** was selected, a new window displaying cleanup results which can be cleared (Clear button), refreshed (Refresh button ), or exported (Export button):

![](/img/legacy/kb/word-image-90.png)

## Cleaning groups

To clean up groups go to **Cleanup Manager** and press the **Groups** radio button:

![](/img/legacy/kb/word-image-91.png)
...
[![](/img/legacy/kb/cleanup-manager.png)](/img/legacy/kb/cleanup-manager.png)
...
![](/img/legacy/kb/word-image-100.png)
