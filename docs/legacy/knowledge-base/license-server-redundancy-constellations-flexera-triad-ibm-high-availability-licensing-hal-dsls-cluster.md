...
The main ‘con' on the IBM LUM list is its lack of popularity in comparison to [Flexnet](https://www.openlm.com/knowledge-base/flexera-flexlm-flexnet-publisher/ "Flexnet") (FlexLM). This has manifested in a trend of licensed application vendor's migration from LUM to various other license management tools, e.g. FlexLM and DSLS.
