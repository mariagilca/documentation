...
sidebar_label: "OpenLM SLM and Identity Service Installation on Linux using RPM, DEB, and TAR Packages"
---

<!-- Source: https://www.openlm.com/knowledge-base/openlm-server-v21-and-identity-service-installation-in-linux-using-rpm-deb-and-tar-packages-kb-876/ -->
...
![](/img/legacy/kb/word-image-161.png)
...
![](/img/legacy/kb/word-image-162.png)
...
![](/img/legacy/kb/word-image-163.png)

![](/img/legacy/kb/word-image-164.png)

Provide the server name, database name, and user credentials (User ID and Password), click **Test Connection** and **Approve** button.

![](/img/legacy/kb/word-image-165.png)

![](/img/legacy/kb/word-image-166.png)
...
![](/img/legacy/kb/word-image-167.png)
...
![](/img/legacy/kb/word-image-168.png)
...
![](/img/legacy/kb/word-image-169.png)
...
## Installing the OpenLM SLM Using DEB
...
![](/img/legacy/kb/word-image-180.png)  
![](/img/legacy/kb/word-image-181.png)

3. Configure the database access.

![](/img/legacy/kb/word-image-182.png)

![](/img/legacy/kb/word-image-183.png)

The following lines files will appear:

![](/img/legacy/kb/word-image-184.png)

4. Check that the OpenLM service is running. Command mentioned below:

-sudo service openlm status

![](/img/legacy/kb/word-image-185.png)
...
![](/img/legacy/kb/word-image-186.png)  
![](/img/legacy/kb/word-image-187.png)

3. Configure the database access.

![](/img/legacy/kb/word-image-188.png)

![](/img/legacy/kb/word-image-189.png)

4. Choose the Identity server port (5000 by default, press enter).

![](/img/legacy/kb/word-image-190.png)

Database created:  
![](/img/legacy/kb/word-image-191.png)
...
![](/img/legacy/kb/word-image-192.png)
...
![](/img/legacy/kb/word-image-200.png)
...
![](/img/legacy/kb/word-image-201.png)
...
![](/img/legacy/kb/word-image-202.png)

cd [destination]

sudo /bin/bash ./installer.sh

![](/img/legacy/kb/word-image-203.png)

2. Create a new database and indicate this database during the Identity Service installation.

![](/img/legacy/kb/word-image-204.png)

![](/img/legacy/kb/word-image-205.png)

3. Choose the identity server port (default 5000, press enter).

![](/img/legacy/kb/word-image-206.png)

![](/img/legacy/kb/word-image-207.png)

4. Open Identity Service via the link: **http://[FQDN]:5000**. Here, FQDN means Fully Qualified Domain Name.

![](/img/legacy/kb/word-image-208.png)
...
**![](/img/legacy/kb/word-image-209.png)**

![](/img/legacy/kb/word-image-210.png)
...
![](/img/legacy/kb/word-image-211.png)
