...
4. Choose your Database option:a. Install the embedded MariaDB (this is only for evaluation purposes):![Database option screen with embedded MariaDB selected](/img/legacy/word-image-63206-2.png)If you select embedded MariaDB, no other steps related to the database are required.  
   Instead, if you continue with your database, you must provide connection string parameters (step 5)b. Or, use your database connection:![Database option screen with custom database connection selected](/img/legacy/word-image-63206-3.png)(*If you choose to provide your database connection, later during the installation process, you will be required to provide database connection string details (step 6).**![Destination Folder screen with Browse button to change install directory](/img/legacy/word-image-63206-4.png)*
...
4. Before proceeding with the upgrade, take a moment to review and accept the End User License Agreement (EULA) terms. The EULA outlines the terms and conditions under which you may use this software. By accepting the agreement, you acknowledge your understanding and agreement to abide by these terms, ensuring legal and responsible use of the software. Click **Next** to continue.  
...
7. Click **Finish.** The upgrade process is completed.  **![Upgrade completed screen with Finish button](/img/legacy/word-image-63206-16.png)**
