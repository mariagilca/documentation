...
To manually organize licensed Autodesk features and packages, use the **Products/Packages** window. In this example, we'll study the case of the Autodesk 3Ds Max Package.
