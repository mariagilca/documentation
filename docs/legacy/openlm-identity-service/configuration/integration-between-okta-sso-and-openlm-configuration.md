...
5. Select **Save.**![Screenshot 2: OpenLM on-premise configuration](/img/legacy/word-image-41990-7-5.png)
...
7. Go back to your OKTA account. Select ****Edit on General setting Section:  
