...
sidebar_position: 2
---
This is a comprehensive guide on how to synchronize the OpenLM Database with an organization's directory service using **Directory Sync.** To see how to set up Directory Sync on Cloud, follow [this guide](/documentation/legacy/software-license-management-cloud-registration-and-configuration-guide-slmc/cloud-directory-sync).
...
**Note:** *If you use Identity Service, configure the DSS in the Identity Service and restart the DSS service. Use* [*this guide*](/documentation/legacy/openlm-identity-service-installation-guide/identity-service-configuration) *for more. If you do not use Identity Service - then no login is required.*
