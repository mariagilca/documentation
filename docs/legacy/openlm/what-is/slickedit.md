...
Usage of the SlickEdit editor is licensed and managed by a proprietary license manager. Here is an explanation of how to [interface](https://www.openlm.com/knowledge-base/interfacing-the-slickedit-license-manager-kb4001o/) SlickEdit to OpenLM in order to monitor license usage and obtain license usage statistics.
...
SlickEdit is only one of over 69 license managers that OpenLM can manage. [Check the list](https://www.openlm.com/license-manager-capabilities/).
