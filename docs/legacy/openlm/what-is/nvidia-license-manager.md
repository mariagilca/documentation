...
**Please note that as of OpenLM Server v4.5, this integration is outdated as the Nvidia License Manager has been replaced with [FlexNet Embedded](https://www.openlm.com/knowledge-base/interfacing-the-flexnet-embedded-license-manager-ht907/).**
