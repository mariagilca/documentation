...
12. Once the password has been changed, you will be redirected to the login page. Use your new credentials to access the Identity Service account. Consult this guide for the recommended [Identity Service configuration](/documentation/legacy/openlm-identity-service-installation-guide/identity-service-configuration).
