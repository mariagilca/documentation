...
5. Click **Save.**![](/img/legacy/word-image-41990-7-5.png)
...
9. Go to the Identity Service webpage. Log out. Now you will be able to log in with OKTA:![](/img/legacy/word-image-41990-11-5.png)

## OpenLM SLMC

If you are an OpenLM SLMC, follow these steps to configure OKTA as an external Identity provider:

1. Navigate to your Cloud Portal instance→Identity&Access Management (IAM)→External Providers→Add Provider.![](/img/legacy/word-image-41990-12-5.png)
2. Input the following details from your Okta account:  
   A. Client ID  
   B. Client Secret  
   C. Authority (example: dev-12345678.okta.com).
3. Provide a public button name (example: Okta).![](/img/legacy/word-image-41990-13-5.png)
