...
2. Go to **License Managers → Add License Manager**.  
   ![Screenshot: Manual configuration (Broker web UI)](/img/legacy/broker-web-ui-1.png)  
3. Select **Hardlock**, enter any port number (for example, `888`), and click **Add**.  
   ![Screenshot 2: Manual configuration (Broker web UI)](/img/legacy/popup-2.png)  
4. In **Vendors**, click **Add Vendor**, enter **Hardlock**, and click **Continue**.  
   ![Screenshot 3: Manual configuration (Broker web UI)](/img/legacy/add-lm-1.png)  
5. In **Log Files**, click **Add Log File**, browse to the `.log` file, and click **Open**.  
6. Select the vendor **Hardlock** and click **Continue**.  
   ![Screenshot 4: Manual configuration (Broker web UI)](/img/legacy/popup-3.png)  
7. Click **Save**.
...
2. Double-click the Hardlock entry.  
   ![Screenshot: Automatic configuration through EasyAdmin](/img/legacy/olm-user-interface-screen-1.png)  
3. Optionally rename the connection, leave the type as **Hardlock**, and click **Approve**.  
   ![Screenshot 2: Automatic configuration through EasyAdmin](/img/legacy/pending-license-manager-screen-1.png)
...
8. Check **Use Broker**.  
9. Click **Save**.  
   ![Screenshot: Manual configuration through EasyAdmin](/img/legacy/add-license-manager-screen-1.png)
