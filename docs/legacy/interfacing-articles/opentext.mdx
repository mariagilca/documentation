---
title: OpenText
description: Configure OpenLM Broker v4.8.8 or higher to interface with the OpenText license manager and monitor license usage.
sidebar_position: 59
---
...
![Diagram: how OpenLM interfaces with OpenText.](/img/legacy/how-openlm-interfaces-with-opentext.png)  
...
![OpenLM Broker log file configuration for OpenText.](/img/legacy/openlm-broker-log-config-for-opentext.png)  
![OpenText Broker property values explained.](/img/legacy/opentext-properties-values-explained.png)
...
![Manually adding the OpenText license server in EasyAdmin.](/img/legacy/Screenshot-2024-04-11-at-10.58.18.png)  
![Completing the manual OpenText license server configuration in EasyAdmin.](/img/legacy/Screenshot-2024-04-11-at-11.01.18.png)
