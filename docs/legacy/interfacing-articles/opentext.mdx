...
![Screenshot: Broker configuration](/img/legacy/how-openlm-interfaces-with-opentext.png)  
...
5. In **Log Files**, click **Add Log File** and browse to the OpenText log file path (for example, `C:\OpenText\ImgLM_##_##_##.txt`).  
...
![Screenshot 2: Broker configuration](/img/legacy/openlm-broker-log-config-for-opentext.png)  
![Screenshot 3: Broker configuration](/img/legacy/opentext-properties-values-explained.png)
...
![Screenshot: Manual](/img/legacy/Screenshot-2024-04-11-at-10.58.18.png)  
![Screenshot 2: Manual](/img/legacy/Screenshot-2024-04-11-at-11.01.18.png)
