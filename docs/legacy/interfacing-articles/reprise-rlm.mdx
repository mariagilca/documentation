...
- **OpenLM SLM** must be installed on a machine in your organization.  
...
## Interface RLM using OpenLM SLM only
...
Install OpenLM Broker on the RLM license server machine. Broker reads RLM logs and license files locally, then sends the data to OpenLM SLM.
