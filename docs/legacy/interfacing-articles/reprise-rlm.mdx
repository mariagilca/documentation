...
- See [how to activate report logs](http://www.reprisesoftware.com/blog/2011/03/how-to-produce-rlm-report-logs/) or refer to the [RLM manual](http://www.reprisesoftware.com/RLM_License_Administration.pdf), under **The ISV Options File → REPORTLOG**.  
