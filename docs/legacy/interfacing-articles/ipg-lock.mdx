...
2. Go to **License Managers → Add License Manager**.  
   ![Screenshot: Manual configuration (Broker web UI)](/img/legacy/word-image-40030-3.png)  
3. Select **IPGLock** from the type dropdown, enter the port number, and click **Add**.  
   ![Screenshot 2: Manual configuration (Broker web UI)](/img/legacy/word-image-40030-4.png)  
4. In the **Commands** tab, confirm the **Service Name** is correct and click **Execute** to verify the Telnet command works.  
   ![Screenshot 3: Manual configuration (Broker web UI)](/img/legacy/word-image-40030-5.png)  
5. Go to the **Vendors** tab → **Add Vendor**, enter **IPGLock**, and click **Continue**.  
   ![Screenshot 4: Manual configuration (Broker web UI)](/img/legacy/word-image-40030-6.png)  
6. Go to the **Log Files** tab, browse to the IPGLock log file, and click **Continue**.  
   ![Screenshot 5: Manual configuration (Broker web UI)](/img/legacy/word-image-40030-7.png)  
7. Click **Save**.
...
2. Click the **Servers pending approval** icon.  
   ![Screenshot: Automatic configuration through EasyAdmin](/img/legacy/word-image-40030-8.png)  
...
4. Optionally rename the connection, leave type as **OpenLM Generic**, ensure **Enabled** is on, and click **Approve**.  
   ![Screenshot 2: Automatic configuration through EasyAdmin](/img/legacy/word-image-40030-9.png)
