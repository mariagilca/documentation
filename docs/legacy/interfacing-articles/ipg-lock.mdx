...
2. Go to **License Managers → Add License Manager**.  
   ![Opening Add License Manager in the OpenLM Broker web UI.](/img/legacy/word-image-40030-3.png)  
3. Select **IPGLock** from the type dropdown, enter the port number, and select **Add**.  
   ![Adding the IPGLock license manager in OpenLM Broker.](/img/legacy/word-image-40030-4.png)  
4. In the **Commands** tab, confirm the **Service Name** is correct and select **Execute** to verify the Telnet command works.  
   ![Verifying the IPGLock Telnet command on the Commands tab in OpenLM Broker.](/img/legacy/word-image-40030-5.png)  
5. Go to the **Vendors** tab → **Add Vendor**, enter **IPGLock**, and select **Continue**.  
   ![Adding the IPGLock vendor on the Vendors tab in OpenLM Broker.](/img/legacy/word-image-40030-6.png)  
6. Go to the **Log Files** tab, browse to the IPGLock log file, and select **Continue**.  
   ![Adding the IPGLock log file on the Log Files tab in OpenLM Broker.](/img/legacy/word-image-40030-7.png)  
7. Select **Save**.
...
2. Select the **Servers pending approval** icon.  
   ![Selecting the Servers pending approval icon in EasyAdmin.](/img/legacy/word-image-40030-8.png)  
...
4. Optionally rename the connection, leave type as **OpenLM Generic**, ensure **Enabled** is on, and select **Approve**.  
   ![Approving the IPGLock entry as OpenLM Generic in EasyAdmin.](/img/legacy/word-image-40030-9.png)
