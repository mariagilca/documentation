...
2. Go to **License Managers** and click **Detect**.
   ...
   ![Screenshot: Automatic configuration](/img/legacy/word-image-97872-2.png)  
...
1. Go to **License Managers** → **Add License Manager**.
   ...
   ![Screenshot: Manual configuration](/img/legacy/word-image-97872-3.png)  
...
4. In the **Executable Path** field, browse to the root folder where Houdini (`sesinetd`) is installed, then click **Save**.
   ...
   ![Screenshot 2: Manual configuration](/img/legacy/word-image-97872-4.png)  
...
5. Go to the **Vendors** tab. Enter `Houdini` as the vendor name and click **Continue**.
   ...
   ![Screenshot 3: Manual configuration](/img/legacy/word-image-97872-5.png)  
...
4. Locate the Houdini entry and click **Approve**.
   ...
   ![Screenshot: Automatic configuration in EasyAdmin](/img/legacy/word-image-97872-6.png)  
