...
OpenLM Broker must be installed on the same machine as Zoo ([installation guide](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/)) and connected to OpenLM Server ([configuration guide](../openlm-broker/openlm-broker-configuration)).  

### Automatic configuration

1. In Broker, select **Detect**.  
   ![Screenshot: Automatic configuration](/img/legacy/word-image-42296-2.png)  
...
![Screenshot: Automatic configuration (EasyAdmin)](/img/legacy/word-image-42296-4.png)  
...
![Screenshot: Manual configuration (EasyAdmin)](/img/legacy/word-image-42296-5.png)  
