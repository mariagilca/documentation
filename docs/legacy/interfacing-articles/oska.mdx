---
title: OSKA
description: Configure OpenLM Broker to monitor the OSKA License Manager, parsing its periodic XML output to report usage in EasyAdmin.
sidebar_position: 61
---
...
- **OpenLM SLM** installed on any Windows machine in the network (can be the same OSKA server).  

The Broker queries the OSKA license server locally and sends data to the OpenLM SLM.  
