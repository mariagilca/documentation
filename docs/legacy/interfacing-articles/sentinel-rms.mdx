...
See the [Broker installation guide](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/) and the [Broker configuration guide](../openlm-broker/openlm-broker-configuration.md).
:::
...
1. Click **Add Port** → enter RMS port (for example, 5093).
