...
1. Directly query the license server from OpenLM SLM.
2. Query the license server locally with OpenLM Broker and propagate the information back to OpenLM SLM.

## OpenLM SLM direct method

### Activating OpenLM SLM to work with SlickEdit

To configure OpenLM SLM to work with SlickEdit:
...
- Reliable communication between OpenLM SLM and the license manager  
