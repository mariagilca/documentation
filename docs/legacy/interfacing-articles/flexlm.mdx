...
Before you begin, [make sure OpenLM Server is installed and configured](../openlm-slm/index.md).
...
For details, see [Multiple FlexLM license pool monitoring](../openlm-slm/multiple-flexlm-license-pool-monitoring-kb4053.md).
