...
2. OpenLM Broker v24.6 or higher installed on a machine in your network and connected to the OpenLM SLM  
...
4. Salesforce API credentials (Consumer Key and Consumer Secret) generated through a Connected App  
   ...
   ![Creating a Salesforce connected app to generate the consumer key and secret.](/img/legacy/word-image-89556-1.png)
...
:::
   ...
   ![Retrieving the consumer key and secret from Manage Consumer Details in Salesforce.](/img/legacy/word-image-89556-2.png)
...
2. Go to **License Managers** → **Add License Manager**.
   ...
   ![Opening Add License Manager in the OpenLM Broker web UI.](/img/legacy/word-image-89556-3.png)
...
2. In **License Manager Servers**, select the **Servers pending approval** icon.
   ...
   ![Selecting the Servers pending approval icon in EasyAdmin.](/img/legacy/word-image-89556-6.png)
...
3. Select the Salesforce entry (shown as **OpenLM Generic**), verify details, and select **Approve**.  
   ...
   ![Approving the Salesforce entry shown as OpenLM Generic in EasyAdmin.](/img/legacy/word-image-89556-7.png)
