...
OpenLM is a [license management and monitoring system](https://www.openlm.com/software-license-management/) for a wide variety of network license types, such as [Flexera FLEXnet Publisher](../what-is/flexera-flexlm-flexnet-publisher.md) (FLEXlm) and Sentinel RMS.  
