...
5. Enter the Canvas port number (for example, `5093`) and select **Add**.
   ...
   ![Screenshot: OpenLM Broker configuration](/img/legacy/word-image-98722-2.png)  
...
6. Select the **Vendors** tab. Select **Add Vendor**.  
   ...
   ![Screenshot 2: OpenLM Broker configuration](/img/legacy/word-image-98722-3.png)  
...
7. Switch to the **Log Files** tab. Select **Add Log File**.  
   ...
   ![Screenshot 3: OpenLM Broker configuration](/img/legacy/word-image-98722-4.png)  
...
2. Select the icon for **Servers Pending Approval**.
   ...
   ![Screenshot: OpenLM configuration](/img/legacy/word-image-98722-5.png)  
   *Pending license managers in EasyAdmin*

3. Double-click the pending license manager.  
   It will be displayed as **OpenLM Generic**.

   ![Screenshot 2: OpenLM configuration](/img/legacy/word-image-98722-6.png)  
...
4. (Optional) Modify the display name. Verify the configuration, then select **Approve**.
   ...
   ![Screenshot 3: OpenLM configuration](/img/legacy/word-image-98722-7.png)  
...
5. (Optional) Switch to the **Custom Fields** tab to add details such as country, usage scope, and description.
   ...
   ![Screenshot 4: OpenLM configuration](/img/legacy/word-image-98722-8.png)  
...
3. Verify that the configured license manager appears in the server list.  
   ...
   ![Screenshot: How to verify your Canvas configuration](/img/legacy/word-image-98722-9.png)  
