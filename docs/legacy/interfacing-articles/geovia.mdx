...
1. **OpenLM SLM v5.6 or higher** installed on-premises or on a Cloud account.  
...
Broker queries license usage through the **NetworkLicenceManager** tool and the **ssilm.log** file. This data is sent to OpenLM SLM for processing.  
...
1. In the Broker configuration tool, select **Detect**.  
   ![Detecting the GEOVIA license manager with the Detect option in OpenLM Broker.](/img/legacy/word-image-42295-2.png)  
...
8. Continue with OpenLM SLM configuration.  
...
2. Select **GEOVIA** from the drop-down and enter the port number.  
   ![Adding the GEOVIA license manager in the OpenLM Broker web UI.](/img/legacy/Screenshot-2023-03-17-at-12.31.24.png)  
3. Under **Commands**, set the path to `NetworkLicenceManager.exe`.  
4. Under **Vendors**, add **Dassault Systèmes** or any descriptive name.  
   ![Adding the Dassault Systemes vendor in the OpenLM Broker web UI.](/img/legacy/Screenshot-2023-03-17-at-12.44.45.png)  
...
2. In **License Manager Servers**, find the server under *Pending approval*.  
   ![GEOVIA license server listed under Pending approval in EasyAdmin.](/img/legacy/word-image-42295-4.png)  
3. Edit the pending server → update the **Display name** if needed → select **Approve**.  
   ![Approving the GEOVIA license server in EasyAdmin.](/img/legacy/word-image-42295-5.png)  

At this point, GEOVIA License Manager is added to OpenLM SLM.  
![GEOVIA License Manager added to OpenLM SLM in EasyAdmin.](/img/legacy/word-image-42295-7.png)  
...
![Configuring the GEOVIA license server manually with Use Broker enabled in EasyAdmin.](/img/legacy/word-image-42295-8.png)  
...
![GEOVIA showing a green status indicator in the EasyAdmin server list.](/img/legacy/word-image-42295-9.png)  
