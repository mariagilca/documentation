...
7. For **Enable HAL configuration**, check this if using [High Availability Licensing (HAL)](../openlm-slm/license-server-redundancy-constellations-flexera-triad-ibm-high-availability-licensing-hal-dsls-cluster.md).  
