...
- OpenLM SLM v21.12 or higher  
- TCP/IP communication activated  
...
:::note
OpenLM Broker must already be installed and configured to report to OpenLM SLM before proceeding.
:::
...
3. From **License Manager Type**, select **GitLab** and select **Apply**.  
...
![Editing GitLab login details in the Broker properties file.](/img/legacy/word-image-2-1.png)  
6. In Broker, select **Execute**, then **Apply**. Ensure the license data output is displayed.  
![Verifying GitLab license data output in the OpenLM Broker desktop UI.](/img/legacy/word-image-3-1.png)  
7. Under **Vendors**, select the vendor placeholder node, enter **GitLab**, and select **Apply**.  
...
![Approving the GitLab license manager from the Pending Approval list in EasyAdmin.](/img/legacy/word-image-4-1.png)  
