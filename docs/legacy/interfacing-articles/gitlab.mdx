...
![Screenshot: Manual configuration (Broker desktop UI)](/img/legacy/word-image-2-1.png)  
6. In Broker, select **Execute**, then **Apply**. Ensure the license data output is displayed.  
![Screenshot 2: Manual configuration (Broker desktop UI)](/img/legacy/word-image-3-1.png)  
...
![Screenshot: Verify your configuration](/img/legacy/word-image-4-1.png)  
