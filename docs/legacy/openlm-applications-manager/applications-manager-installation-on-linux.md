...
- Obtains information from the Workstation Agent regarding active processes and software launches on the end-user workstation
- Allows Workstation Agents to launch software according to specific rules and configurations

The Applications Manager interacts with the Workstation Agent which is a lightweight component that is installed on the end-user's workstation. It has the following features:
...
1. Obtain the distribution package from the [download](https://www.openlm.com/downloads/) page (tar.gz).
...
![Linux console during Applications Manager installation.](/img/legacy/word-image-41960-1.png)

3. Change directory to the installation folder.

![Changing to the Applications Manager installation folder in the Linux console.](/img/legacy/word-image-41960-2.png)

4. Set JAVA\_HOME path in settings.sh

![Setting the JAVA_HOME path in the settings.sh file.](/img/legacy/word-image-41960-3.png)
...
![Adding the Client ID and Secret Key in the openlm-app-manager.properties file.](/img/legacy/word-image-41960-4.png)

![The Client ID and Secret Key entries in the openlm-app-manager.properties file.](/img/legacy/word-image-41960-5.png)
