...
3. In the EasyAdmin user interface select **'Start' → 'Administration' → "Unmanaged Processes".  
   ![EasyAdmin Administration menu with Unmanaged Processes selected.](/img/legacy/Screenshot-2023-02-09-at-10.54.10.png)**
4. In the "Unmanaged Processes" window, select the "Add Vendor" icon to add the Vendor to the list of monitored vendors.  
   ![Unmanaged Processes window with the Add Vendor icon for adding a vendor to the monitored list.](/img/legacy/Screenshot-2023-02-09-at-10.56.15.png)
5. The Add Vendor pop-up opens:  
   ![Add Vendor pop-up with fields for vendor name, feature name, process name, and description.](/img/legacy/Screenshot-2023-02-09-at-11.00.01.png)
