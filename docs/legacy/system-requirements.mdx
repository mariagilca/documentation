...
- End-User Services needs to connect to these TCP ports: **5015** (default for OpenLM SLM), **5000** (OpenLM Identity, if used) and listen to TCP **53555** (can be changed in `appsettings.json`)
...
When installed separately from OpenLM SLM:
