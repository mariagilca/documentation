...
Please refer to the following link for the list of best practices for each of the above database types: [OpenLM Database Optimal Configuration – Recommendations](https://www.openlm.com/knowledge-base/openlm-database-optimal-configuration-recommendations/).
...
For Edge, it is recommended to use the latest version (or at least Chromium-based Edge).
