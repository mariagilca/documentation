...
For step-by-step instructions on how to monitor FlexNet Embedded servers with OpenLM, consult the [FlexNet Embedded integration](../interfacing-articles/flexnet-embedded).
