...
FlexNet Embedded (FNE) is only one of over 70 license managers that OpenLM can manage. [Check the list](https://www.openlm.com/license-manager-capabilities/).

For step-by-step instructions on how to monitor FlexNet Embedded servers with OpenLM, consult [HT907](https://www.openlm.com/knowledge-base/interfacing-the-flexnet-embedded-license-manager-ht907/).
