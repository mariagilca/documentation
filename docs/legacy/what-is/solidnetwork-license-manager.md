...
OpenLM provides the following functionality for monitoring SOLIDWORKS licenses:
...
SOLIDWORKS is only one of over 70 license managers that OpenLM can manage. [Check the list](https://www.openlm.com/license-manager-capabilities/).
