...
- Multiple maps, multiple layout view: ArcGIS Pro introduces a multiple layout approach, enabling data from multiple views to be synchronized and presented together, combining visual information. One such alternative is the combination of 2D and 3D views. [See this Esri presentation](http://video.esri.com/watch/2533/unveiling-the-new-arcgis-professional-application-with-jim-mckinney-and-jack-dangermond) for elaboration.
