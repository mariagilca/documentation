...
- Project based workflows: The same Data files, that is, Maps (.mxd), Scenes (.sxd) and Globes (.3DD) can all be imported into ArcGIS Pro. Once in ArcGIS Pro these can be saved and processed as Projects (.aprx).
- Multiple maps, multiple layout view: ArcGIS Pro introduces a multiple layout approach, activating data from multiple views to be synchronized and presented together, combining visual information. One such alternative is the combination of 2D and 3D views. [See this Esri presentation](https://video.esri.com/watch/2533/unveiling-the-new-arcgis-professional-application-with-jim-mckinney-and-jack-dangermond) for elaboration.
...
[OpenLM](https://www.openlm.com/) is a general purpose application for monitoring floating license usage. As it was originated by Esri veterans, it provides specific benefits for Esri users. OpenLM will continue supporting ArcGIS license monitoring into the upcoming version.
