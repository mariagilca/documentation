...
To open the configuration, select **[Start] > [OpenLM] > [OpenLM Broker]** (default path: C:\ProgramData\Microsoft\Windows\Start Menu\Programs\OpenLM\OpenLM Broker). This will open the OpenLM Broker Configuration Tool (see **Figure 1**) which allows the setup of OpenLM Broker, OpenLM SLMs, and license servers.

**![OpenLM Broker Configuration Tool immediately after installation.](/img/legacy/word-image-220.png)  
...
3. Select the **[+Add OpenLM SLM]** button. The OpenLM SLM connectivity panel will appear at the right of the screen prefilled with default information (see **Figure 2**).

**![OpenLM Broker Configuration Tool with the Connectivity panel displayed.](/img/legacy/word-image-221.png)  
...
**![Clean Buffer confirmation screen.](/img/legacy/word-image-222.png)  
...
**![Clean Buffer reminder screen.](/img/legacy/word-image-223.png)  
Figure 4: The Clean Buffer reminder.**

**![Confirmation screen for saving data changes.](/img/legacy/word-image-224.png)  
Figure 5: Confirmation screen for data changes**

ii. An error screen opens if Broker appears to be stopped. (see **Figure 6**).

**![Broker connection error screen.](/img/legacy/word-image-225.png)  
...
**![Broker restart success screen.](/img/legacy/word-image-226.png)  
...
**![Connectivity check countdown screen.](/img/legacy/word-image-227.png)  
Figure 8: Countdown screen.**  
![OpenLM SLM connection success screen.](/img/legacy/word-image-228.png)  
**Figure 9: Connection success.**

**![OpenLM SLM connection failure screen.](/img/legacy/word-image-229.png)  
...
![License Manager panel for the selected license server.](/img/legacy/word-image-230.png)  
...
![Add New Port dialog.](/img/legacy/word-image-231.png)  
...
**![OpenLM Broker Configuration Tool displaying the License Manager Port panel.](/img/legacy/word-image-232.png)  
...
![Update Commands confirmation screen.](/img/legacy/word-image-233.png)

**Figure 14: The Update Commands Confirmation screen.**
...
**![Save success screen for License Manager changes.](/img/legacy/word-image-234.png)  
...
**![Commands node expanded in the configuration tree.](/img/legacy/word-image-235.png)  
...
1. Navigate to the License Manager Port panel of the OpenLM Broker Configuration Tool by selecting the port to configure in the navigation panel to the left of the screen.
...
**![License Manager Port panel with the Advanced options revealed.](/img/legacy/word-image-236.png)  
...
i. Check the **Set Path Manually** checkbox by selecting it. This will activate the **[Add]** button to the right of the entry field.

ii. Select **[Add]**. This will call a file browser.

iii. Navigate to the location of the desired license file in the file browser and select the file name to highlight it.

iv. Select **[Open]**. This will place the path to the license file in the Path field (see **Figure 18**).

**![Path field populated with the license file by the Add button.](/img/legacy/word-image-237.png)  
...
**![Update Commands confirmation screen.](/img/legacy/word-image-238.png)  
...
**![Save confirmation screen.](/img/legacy/word-image-239.png)  
...
**![Read-only display of the license file content.](/img/legacy/word-image-240.png)  
...
![Asset Info Order screen for sorting license files.](/img/legacy/word-image-241.png)

**Figure 22: The Asset Info Order screen.**
...
*[NOTE: Upon installation, some paths will be automatically detected. Other license manager command paths are set by default to C:\Program Files\OpenLM\OpenLM Broker\tools. All Commands will not all be available for every license manager type.]*
...
**![OpenLM Broker Configuration Tool with a port node expanded.](/img/legacy/word-image-242.png)  
Figure 23: The OpenLM Broker Configuration Tool with a port node expanded.**

2. Select the **Commands** node under the expanded port that you want to configure. The current configuration for the command will be displayed in the Command Definition panel on the right which will be context sensitive.
...
**![Execute confirmation screen showing a successful command.](/img/legacy/word-image-243.png)  
Figure 24: Execute confirmation screen with generic content.**

**![Execute confirmation screen showing command error content.](/img/legacy/word-image-244.png)  
...
i. Select the command in the navigation tree. The information for the command will appear on the Command Definition screen.
...
**![Command update confirmation screen after selecting Apply.](/img/legacy/word-image-245.png)  
...
**![Broker restart confirmation screen.](/img/legacy/word-image-246.png)  
Figure 27: Confirmation screen for the Broker restart.**

b. To update all command paths under a Command node:

i. Select the Command node where the commands reside. The Commands panel will display to the right.
...
**![Command update confirmation screen.](/img/legacy/word-image-247.png)  
...
**![Command update confirmation screen after selecting Apply.](/img/legacy/word-image-248.png)  
...
**![Broker restart confirmation screen.](/img/legacy/word-image-249.png)  
...
2. Select the **[+]** to the left of the **Vendors** node under the port. The Vendor Definition panel will display on the right of the OpenLM Broker Configuration Tool screen.
...
4. Select "**Vendor Name to Be Filled**" and the Vendor Definition panel will display additional fields to be used in the definition (see **Figure 31**).

**![Vendor Name to Be Filled node highlighted with the Vendor Definition fields.](/img/legacy/word-image-250.png)  
...
8. Select the **"Advanced>>"** link to display the advanced options on the bottom of the panel if they are not displayed already.
...
**![Command update confirmation screen after selecting Apply.](/img/legacy/word-image-251.png)  
...
**![Broker restart confirmation screen.](/img/legacy/word-image-252.png)  
...
2. Select the **Log Files** node. This displays the Log File Definition panel and reveals the **[+Add Log File]** button above the navigation panel (see **Figure 34**).

**![Log Files node highlighted with the Add Log File button.](/img/legacy/word-image-253.png)  
...
*8. [Optional]* Select the **"Advanced>>"** link to display the advanced options on the bottom of the panel if they are not displayed already. *[NOTE: Keep the default values for these parameters to avoid performance issues.]*
...
**![Command update confirmation screen after selecting Apply.](/img/legacy/word-image-254.png)  
...
**![Broker restart confirmation screen.](/img/legacy/word-image-255.png)  
...
1. Select the **Advanced Settings** node in the navigation panel of the OpenLM Broker Configuration Tool to display the Advanced Settings panel (see **Figure 37**).

**![OpenLM Broker Configuration Tool with the Advanced Settings panel displayed.](/img/legacy/word-image-256.png)  
...
**![Command update confirmation screen after selecting Apply.](/img/legacy/word-image-257.png)  
...
**![Broker restart confirmation screen.](/img/legacy/word-image-258.png)  
...
![Reset confirmation screen.](/img/legacy/word-image-259.png)

**Figure 40: The Reset confirmation screen.**
...
**![Detecting existing license servers after a reset.](/img/legacy/word-image-260.png)  
...
**![Broker restart confirmation screen.](/img/legacy/word-image-261.png)  
...
**![Recording Configuration panel with port 27080 selected.](/img/legacy/word-image-262.png)  
...
**![Typical OpenLM Broker Configuration Tool screen with the Apply, Restart Broker, and Exit buttons.](/img/legacy/word-image-263.png)  
