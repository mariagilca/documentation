...
6.1. Open the OpenLM EasyAdmin User Interface, and select Start  →  Options file → Opt. File Management.
...
Refer to this application note for more information on importing users[through Options file reading](https://www.openlm.com/knowledge-base/importing-users-and-groups-via-the-options-files-reading-mechanism-kb4037a/).
