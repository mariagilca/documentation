...
2. Open Swagger UI and select on Authorize. ![Screenshot: How to use Swagger](/img/legacy/word-image-41988-1-1.png)
...
4. Select the desired API method. ![Screenshot 3: How to use Swagger](/img/legacy/word-image-41988-3-1.png)
