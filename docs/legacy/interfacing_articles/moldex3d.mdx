...
:::note
Ensure Broker is [installed](../knowledge-base/openlm-broker-installation-21-xand-higher-windows.md) and [configured](../knowledge-base/openlm-broker-configuration.md) to report to OpenLM Server before proceeding.
:::
