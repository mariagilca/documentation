...
:::note
OpenLM Broker must already be [installed](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/) and [configured](../knowledge-base/openlm-broker-configuration.md) to report to OpenLM Server before proceeding.
:::
