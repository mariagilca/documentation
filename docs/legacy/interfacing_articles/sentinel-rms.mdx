...
See the [Broker installation guide](https://www.openlm.com/application-notes-v3-0/installing-openlm-v3-0/broker-comprehensive-installation-guide-an4004b/) and the [Broker configuration guide](../knowledge-base/openlm-broker-configuration.md).
:::
