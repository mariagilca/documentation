...
![Diagram: OpenLM interfacing with RLM via Server only](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-1.png)
...
2. Go to **Start → Administration → License Manager Servers**.  
   ![License manager servers menu](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-2.png)  
3. The License Manager Servers window opens.  
   ![License manager servers window](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-3.png)  
4. Click **Add LM**.  
...
12. Click **Save**.  
   ![RLM server configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-4.png)

## Interface RLM using OpenLM Broker

![Diagram: OpenLM interfacing with RLM via Broker](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-5.png)
...
- See [how to enable report logs](http://www.reprisesoftware.com/blog/2011/03/how-to-produce-rlm-report-logs/) or refer to the [RLM manual](http://www.reprisesoftware.com/RLM_License_Administration.pdf), under **The ISV Options File → REPORTLOG**.  
...
![Automatic Broker detection](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-6.png)
...
4. Enable **Set Path Manually** → **Add License File Manually**. Enter the license file path.  
...
6. In **Commands**, set the path to `rlmutil.exe` (typically `C:\RLMServer`). Click **Execute** to test.  
   ...
   :::  
   ![Broker commands configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-7.png)  
...
9. In **Log Files**, click **Add Log File**, enter the path, and link it to the vendor.  
   ![Add RLM log file](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-8.png)  
10. Click **Save**.
...
2. In the License Servers window, approve the pending RLM license manager.  
   ![Approve RLM in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42307-9.png)
