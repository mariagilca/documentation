...
OpenLM is a [license management and monitoring system](https://www.openlm.com/software-license-management/) for a wide variety of network license types, such as [Flexera FLEXnet Publisher](https://www.openlm.com/knowledge-base/flexera-flexlm-flexnet-publisher/) (FLEXlm) and Sentinel RMS.  
...
![How Broker interfaces EasyCopy License Manager with OpenLM Server](https://cdn.openlm.com/wp-content/uploads/2021/02/how-broker-interfaces-with-openlm-server-1.png)
...
2. In EasyAdmin, go to **Administration → License Manager Servers → Add LM → Type**.  
   ![OpenLM Server Add LM](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42320-2.png)  
...
9. **Allow Server fall back to denied license**: enable this if you want the system to disregard denials when the user successfully obtains a license from another EasyCopy server.  
   ![Allow Server Fallback](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42320-3.png)  
10. Switch to the **Custom fields** tab and fill in details such as **Country**, **Usage Scope**, and **Description**.  
    ![Custom fields](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42320-4.png)  
11. Click **Save**.  

### OpenLM Broker configuration

1. [Download and install the latest OpenLM Broker](https://www.openlm.com/knowledge-base/openlm-broker-installation-guide-quick-reference-kb4004a/).  
...
5. Enter the same license server name and port number you used in OpenLM Server (for example, *easycopy_server*, *123*).  
   ![Broker license server configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42320-5.png)  
...
7.	Click Apply and then Restart Broker.
## Alternative: Manual Broker Web UI Configuration
	...
	4.	Click Add License Manager. From the LM type list, select OpenLM Generic. Enter the port (for example, 123) and click Add.
  5.	In the Commands tab, enter the path to eclic.exe openlm. Click Execute to verify output.
  6.	In the Vendors tab, click Add Vendor and enter EasyCopy.
	7.	Click Save.
