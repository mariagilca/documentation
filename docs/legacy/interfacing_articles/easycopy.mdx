...
OpenLM is a [license management and monitoring system](https://www.openlm.com/software-license-management/) for a wide variety of network license types, such as [Flexera FLEXnet Publisher](../knowledge-base/flexera-flexlm-flexnet-publisher.md) (FLEXlm) and Sentinel RMS.  
...
1. [Download and install the latest OpenLM Broker](../knowledge-base/openlm-broker-installation-guide-quick-reference-kb4004a.md).  
