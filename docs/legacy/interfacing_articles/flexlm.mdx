...
![OpenLM Server interfacing with FlexLM directly](https://www.openlm.com/wp-content/uploads/2017/01/openlm-server-interfacing-directly-with-the-lm.png)  
*OpenLM Server querying FlexLM remotely*

Before you begin, [make sure OpenLM Server is installed and configured](https://www.openlm.com/knowledge-base/openlm-server-installation-guide-v21-and-above/).

### Steps

1. In **EasyAdmin → Start → Administration → License Manager Servers**, click **Add LM**.  
   ![Adding a license manager](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-description.png)  
...
8. Test the connection.  
   ...
   - Success:  
     ![Successful connection](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-text-application-word.png)  
     *Successful connection test*  

   - Failure:  
     ![Failed connection](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-description-1.png)  
...
![LM Tools configuration](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-text-application-descr.png)  
...
![OpenLM Broker with FlexLM](https://www.openlm.com/wp-content/uploads/2017/01/broker-interface-with-log-and-license-files.png)  
...
![Broker auto-detect](https://www.openlm.com/wp-content/uploads/2017/01/word-image-26383-7.png)  
...
5. In **Settings**, add the license file path.  
   ![License file path settings](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-description-2.png)  

6. In **Commands**, verify the correct path and click **Execute**.  
   ![Command settings](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-description-3.png)  
...
9. Expand **Options File Details** to configure file path and backup.  
   ![Options file details](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-teams-desc.png)  

10. In **Log Files**, click **Add Log File**.  
11. Select **FlexLM Debug Log File** and set the path.  
    ![Log file configuration](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-description-4.png)  
...
3. Double-click the new FlexLM server entry.  
   ![Approve FlexLM in EasyAdmin](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-text-application-email.png)  
4. Click **Approve**.  

![Approved FlexLM configuration](https://www.openlm.com/wp-content/uploads/2017/01/graphical-user-interface-application-description-5.png)  
...
For details, see [Multiple FlexLM license pool monitoring](https://www.openlm.com/knowledge-base/multiple-flexlm-license-pool-monitoring-kb4053/).
...
See:  
- [Options file management using EasyAdmin](https://www.openlm.com/knowledge-base/options-file-management-using-openlm-easyadmin-kb4007/)  
- [Importing users and groups from options files](https://www.openlm.com/knowledge-base/importing-users-and-groups-via-the-options-files-reading-mechanism-kb4037a/)  
