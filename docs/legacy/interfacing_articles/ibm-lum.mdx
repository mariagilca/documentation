...
7. For **Enable HAL configuration**, check this if using [High Availability Licensing (HAL)](../knowledge-base/license-server-redundancy-constellations-flexera-triad-ibm-high-availability-licensing-hal-dsls-cluster.md).  
