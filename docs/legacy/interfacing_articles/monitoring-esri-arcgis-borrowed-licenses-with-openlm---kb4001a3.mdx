...
For more information on how to install the OpenLM Server and OpenLM Broker, and how to read the Audit log file, [please refer to this document](../knowledge-base/configuring-openlm-to-interface-the-flexlm-license-manager-kb4001a.md)
