...
![Diagram of how OpenLM interfaces with the Razorcat license manager](https://www.openlm.com/wp-content/uploads/2022/06/how-openlm-interfaces-with-the-razorcatlicensemoni.png)  
...
1. Click **Add Port**.  
2. Enter the Razorcat server port number (e.g., `36679`).  
...
2. Go to **License Managers → Add License Manager**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-3.png)  
3. Select **Razorcat** from the type dropdown, enter the port number, and click **Add**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-4.png)  
4. In the **Commands** tab, set the **Executable Path** to the folder containing `flsutil.exe` (or browse with the magnifier icon).  
5. Enter the **Service Name** (e.g., `Razorcat`).  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-5.png)  
6. Go to the **Vendors** tab → **Add Vendor**, enter **Razorcat**, and click **Continue**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-6.png)  
7. Click **Save**.
...
2. Click the **Servers pending approval** icon.  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-7.png)  
...
4. Optionally rename the connection, leave type as **OpenLM Generic**, ensure **Enabled** is on, and click **Approve**.  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-8.png)
...
4. Enter a description (e.g., "Razorcat").  
...
3. Confirm that Razorcat appears in the list with a green status circle.  
   ![](https://www.openlm.com/wp-content/uploads/2022/06/word-image-38965-9.png)  
