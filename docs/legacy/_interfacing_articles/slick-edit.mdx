...
[SlickEdit](http://www.slickedit.com/) is a cross-platform, multi-language source code and text editor. It provides various coding tools and time-saving programming features. SlickEdit 2014 supports over 40 languages across 9 different platforms.
...
### Enabling OpenLM Server to work with SlickEdit
...
![Configuring EasyAdmin to work with SlickEdit](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-1.png)  
...
2. Select the **LM Servers** tab and click **Add License Manager**.
...
9. Click **Save**. Restart the OpenLM Server service in Windows Services.

![Adding SlickEdit server in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-2.png)  
...
2. In Broker, select the license manager node. Click **Add Port** if Auto-Detect did not find SlickEdit.
...
5. In the **Commands** node, enter the full path to the `selicutil.exe` executable. Click **Update** and **Apply**.
6. Set the SlickEdit commands for **Status** and **Data_inquiry** as shown in the image below, replacing `<fullpath>` with the actual path to `selicutil.exe`.

![Configuring Broker commands for SlickEdit](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-3.png)  
*Configuring Broker commands for SlickEdit.*

7. Click **Restart Broker**.
8. You can also configure Broker via the [Broker web UI](https://www.openlm.com/knowledge-base/openlm-broker-webui/).

![Configuring SlickEdit in Broker web UI](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-4-1.png)  
...
1. Open **EasyAdmin**.
2. Click the link for **Pending Approval** and approve the SlickEdit server.
3. Confirm that the license manager appears in the server list.  
A green circle node indicates an active connection.

![Approving SlickEdit in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-5.png)  
*Approving SlickEdit in EasyAdmin.*

![SlickEdit license server approved in EasyAdmin](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-6.png)  
*SlickEdit license server approved in EasyAdmin.*

![SlickEdit license manager active connection indicator](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42302-7.png)  
