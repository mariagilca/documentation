...
![OpenLM Server interfacing directly with the LM](https://cdn.openlm.com/wp-content/uploads/2021/02/openlm-server-interfacing-directly-with-the-lm-1.png)
...
9. In **LM Tools**, select **Green Hills** from the drop-down and enter the full path to the Green Hills executable.  
   ...
   ![Green Hills LM Tools configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42316-3.png)  
...
![How Broker interfaces with OpenLM Server](https://cdn.openlm.com/wp-content/uploads/2021/02/how-broker-interfaces-with-openlm-server.png)
...
2. Click **Add Port**.  
3. Enter the license server **Port** (e.g. `2009`).  
...
7. Click **Execute** to confirm functionality.  
   ...
   ![Green Hills Broker configuration](https://cdn.openlm.com/wp-content/uploads/2021/02/word-image-42316-5.png)  
...
3. Select **Green Hills** from the drop-down and enter any port (e.g. `888`). Click **Add**.  
