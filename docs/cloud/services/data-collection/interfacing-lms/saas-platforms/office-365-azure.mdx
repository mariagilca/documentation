...
- OpenLM Components: OpenLM Cloud Broker and OpenLM SLM are required. For automation, you may also need OneDirectorySync (for user removal) or License Allocation Control (for license allocation).
