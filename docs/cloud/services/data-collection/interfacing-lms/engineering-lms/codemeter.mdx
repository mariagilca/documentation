...
1. OpenLM Platform
2. OpenLM Broker v25.x or higher installed on the same machine as CodeMeter, and approve it in [Broker Hub](/cloud/services/data-collection/broker-hub).
