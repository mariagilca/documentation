...
1. OpenLM Platform
2. OpenLM Broker v25.x or higher installed on the same machine as Zoo, and approve it in [Broker Hub](/cloud/services/data-collection/broker-hub).
...
1. Point to the CSV Zoo log file (default: C:\ProgramData\McNeel\Zoo#.#\Usage, where #.# is version, e.g., 6.0).
