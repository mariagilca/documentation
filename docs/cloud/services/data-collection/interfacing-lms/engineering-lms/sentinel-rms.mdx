...
- OpenLM Broker v25.x or higher installed on the same machine as Sentinel RMS, and approve it in [Broker Hub](/cloud/services/data-collection/broker-hub).
...
1. From Menu, go to License Servers.
    ...
    ![On left menu, select Pending Server](/img/engineering-lms/sentinel-rms/image10.png)

1. On left menu, select Pending Server

1. On the list, select the Sentinel RMS license manager and click on Approve and Merge

    ![Enabling token calculator](/img/engineering-lms/sentinel-rms/image3.png)
...
1. Ensure Sentinel RMS appears in the list with a green status indicator.
