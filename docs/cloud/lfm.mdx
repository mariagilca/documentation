...
Open the OpenLM Platform **app launcher** (grid icon, top-right) and select **Licenses and Features → License File Management**.

**Before you start:** LFM lists license files collected from [Broker Hub](/cloud/data-collection/broker-hub), so your Brokers must be installed and reporting before any files appear.

**Related:** [Software License Manager (SLM)](/cloud/slm/license-servers) · [Alerts](/cloud/automations/alerts)
:::
