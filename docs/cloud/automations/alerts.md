...
* Filter by time, source, or severity (for example, Critical, Warning, Info).
...
2. Activate/deactivate notification methods (email or ticket).
...
Follow these recommendations to get the most out of your alert configuration.
