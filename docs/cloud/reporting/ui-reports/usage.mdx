...
Open the OpenLM Platform **app launcher** (grid icon, top-right) and select **Licenses and Features → Usage**.

**Before you start:** Install the [OpenLM Workstation Agent](/cloud/getting-started/install-workstation-agent) on end-user machines for complete data — without it, Usage shows only partial data collected through the OpenLM Broker.

**Related:** [OpenLM Broker](/cloud/data-collection/openlm-broker)
:::
