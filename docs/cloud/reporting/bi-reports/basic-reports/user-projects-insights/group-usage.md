...
- **Usage Time in Hours by Group Name Pie Chart:** It shows the usage time in hours by different groups.
...
- **Group Usage Details Table:** It shows the total usage time in hours and the percentage share of usage for each group.
