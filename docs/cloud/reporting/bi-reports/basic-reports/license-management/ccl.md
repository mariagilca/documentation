...
- **Currently Consumed Licenses Table:** This table provides a detailed view of currently consumed license sessions through a tabular layout. It includes essential information such as the user's identity, license feature details, associated product metadata, session start time, workstation and IP, as well as usage duration and idle time. The data helps monitor active consumption in real time.
