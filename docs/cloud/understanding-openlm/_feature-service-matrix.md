...
| Software asset management     | Manages software licenses by tracking purchases, entitlements, and usage.   | Software Asset Management (SAM)       | Reporting Service                          | Reporting Service active; Activate from Products Service; License servers and Workstation Agents for data. |
