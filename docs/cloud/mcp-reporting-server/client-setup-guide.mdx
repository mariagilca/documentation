...
2. Open Claude Desktop. Select your profile icon, then select **Settings** → **Developer** → **Edit Config**.
...
5. You are redirected to the browser for authentication. Sign in with your OpenLM credentials.
6. After successful login, the MCP tools icon appears in the chat input area. The server is ready to use.
