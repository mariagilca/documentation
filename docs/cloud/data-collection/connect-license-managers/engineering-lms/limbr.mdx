...
1. To verify, go to Commands → data_query and select Execute.
...
1. Set License Manager Type to LiMBR and select Apply.

1. In Commands, browse to the folder where LiMBR is installed, select Update, then Apply.

1. In status, check configuration.

1. In data_inquiry, select Execute and ensure the output is valid.

1. Select Restart Broker.

1. Under Vendors, enter LiMBR in Vendor Name and select Apply.
