...
1. Select Gitlab, enter the port number, and select Add.
...
1. In C:\Program Files\OpenLM\OpenLM Broker, open the gitlab@80.properties file, provide login information, and save.
    ...
    ![In Broker, select Execute, then Apply. Ensure the license data output is displayed.](/img/engineering-lms/gitlab/image102.png)
*In Broker, select Execute, then Apply. Ensure the license data output is displayed.*

1. Under Vendors, select the vendor placeholder node, enter GitLab, and select Apply.
