...
1. Go to License Managers → Add License Manager.
    ...
    ![Select IPGLock, enter the port number, and click Add.](/img/engineering-lms/ipg-lock/image60.png)
*Select IPGLock, enter the port number, and click Add.*

    ![In the Commands tab, confirm the Service Name is correct and click Execute to verify the Telnet command works.](/img/engineering-lms/ipg-lock/image118.png)
*In the Commands tab, confirm the Service Name is correct and click Execute to verify the Telnet command works.*

    ![Go to the Vendors tab → Add Vendor, enter IPGLock, and click Continue.](/img/engineering-lms/ipg-lock/image111.png)
*Go to the Vendors tab → Add Vendor, enter IPGLock, and click Continue.*

    ![Go to the Log Files tab, browse to the IPGLock log file, and click Continue.](/img/engineering-lms/ipg-lock/image106.png)
