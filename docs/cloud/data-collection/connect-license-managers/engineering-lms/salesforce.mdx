...
1. Go to License Managers → Add License Manager.
    ...
    ![From the drop-down list, select Salesforce, enter any port number (required for setup even if unused), and select Add.](/img/engineering-lms/salesforce/image89.png)
*From the drop-down list, select Salesforce, enter any port number (required for setup even if unused), and select Add.*

1. Go to Vendors and optionally add Salesforce as the vendor.

1. Open the Advanced tab, select the Edit (pen) icon, and fill in:
