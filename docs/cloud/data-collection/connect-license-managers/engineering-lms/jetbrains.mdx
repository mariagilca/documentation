...
1. From Type, select JetBrains. Select Apply.

1. In Commands, set the Update path for commands to the JetBrains FLS root folder. Select Update → Apply.
...
1. Under Vendors, set Vendor Name = JetBrains. Select Apply.
