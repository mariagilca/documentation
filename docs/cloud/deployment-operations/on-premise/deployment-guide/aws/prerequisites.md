...
Before deploying the OpenLM Platform, verify that the AWS infrastructure provisioned in [Environment setup](./environment-setup) meets the requirements below.
