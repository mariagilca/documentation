...
The values below represent a baseline sizing for Azure deployments. These may evolve over time and should be adjusted based on the scale and load of each environment.
