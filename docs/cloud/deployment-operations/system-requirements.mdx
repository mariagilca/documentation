...
AI Proxy runs as a Docker Compose stack on a Linux host, not as a desktop installer. The essentials:

- A 64-bit Linux host with Docker Engine and the Docker Compose v2 plugin.
- 2 vCPU and 4 GB of RAM minimum (4 vCPU and 8 GB recommended).
- Outbound HTTPS (port 443) to your LLM providers and to OpenLM Platform.

For full host, hardware, and network details, see [AI Proxy system requirements](/cloud/deployment-operations/ai-proxy/system-requirements).
