...
<TabItem value="ai-proxy" label="AI Proxy">
...
1. [AI Proxy overview](/cloud/deployment-operations/ai-proxy/) — what it does and how it fits OpenLM Platform.
2. [Deploy AI Proxy](/cloud/deployment-operations/ai-proxy/deployment) — run the Docker Compose stack in your network.
3. [Configure AI Proxy](/cloud/deployment-operations/ai-proxy/configuration) — connect to OpenLM Platform, set up providers, and route clients.
